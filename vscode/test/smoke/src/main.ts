...
import { setup as setupSingularityCliTests } from './areas/chat/singularityCli.test';
...
describe(`VSCode Smoke Tests (${opts.web ? 'Web' : 'Electron'})`, () => {
	...
	if (!opts.web && !opts.remote && quality !== Quality.Dev && quality !== Quality.OSS) { setupSingularityCliTests(logger); }
