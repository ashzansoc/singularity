 ...
 * each surface:
 *   - {@link shellEchoScenario} matches SDK-based sessions (Singularity CLI,
 ...
 *   - Singularity CLI (responses-API):     `{ "output": "<reply>" }`
 ...
 * matches:
 *   - the value side of any `"<key>": "<reply>..."` pair (Singularity CLI, Claude,
