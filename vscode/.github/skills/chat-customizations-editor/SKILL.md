...
Split-view management pane for AI customization items across workspace, user, extension, and plugin storage. Supports harness-based filtering (Local, Singularity CLI, Claude).
...
2. Mock `IProductService.defaultChatAgent.chatExtensionId` (e.g., `'Singularity.singularity-chat'`)
