...
├── agenthost.log               # Agent host process (Singularity agent, model listing, agent sessions)
...
| Singularity / agent issues | `agenthost.log`, `window1/exthost/Singularity.singularity-chat/` |
