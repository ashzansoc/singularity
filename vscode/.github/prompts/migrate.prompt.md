...
Use this prompt when migrating issues from one GitHub repository to another (e.g., from `microsoft/vscode-singularity` to `microsoft/vscode`).
...
```
https://github.com/microsoft/vscode-singularity/issues?q=is%3Aissue+is%3Aopen+assignee%3Ayoyokrazy
```
...
```
repo:microsoft/vscode-singularity is:issue is:open assignee:yoyokrazy
```
...
```
https://github.com/microsoft/vscode-singularity/issues/12345
```
...
✅ Correct: `https://github.com/microsoft/vscode-singularity/issues/12345`
✅ Also OK: `microsoft/vscode-singularity#12345`
...
### Original Issue Body (in `microsoft/vscode-singularity`):
...
```markdown
_Transferred from microsoft/vscode-singularity#12345_
_Original author: `@originalauthor`_

---

I noticed `@johndoe` had a similar issue in https://github.com/microsoft/vscode-singularity/issues/9999. cc `@janedoe` for visibility.

Related to https://github.com/microsoft/vscode-singularity/issues/8888 and microsoft/vscode#12345.
