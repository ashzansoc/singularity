 ...
 *
 * Uses the real singularity extension with IS_SCENARIO_AUTOMATION=1 and a local
...
function buildProductionBuild() {
	...
	try {
		...
		// The singularity shim step may fail locally when the singularity SDK is not
