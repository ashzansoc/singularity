...
/**
 * Shared definition of the Singularity "policy" endpoints that
	...
	const endpoints: EndpointDef[] = [
		{
			...
			path: '/singularity_internal/managed_settings',
			productKey: 'managedSettingsUrl',
			description: 'Enterprise singularity settings from .github/singularity/settings.json. An empty object means no policy file is present.',
			presets: [
				{
					id: 'empty',
		...
		},
		{
			id: 'entitlements',
			label: 'Entitlements',
			path: '/singularity_internal/user',
			...
			presets: [
				{
					...
					body: {
						access_type_sku: 'singularity_enterprise_seat',
						chat_enabled: true,
		...
		},
		{
			id: 'token',
			label: 'Token',
			path: '/singularity_internal/v2/token',
