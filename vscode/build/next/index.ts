...
const commonResourcePatterns = [
	...
	'vs/workbench/browser/media/singularity-logo-*.{png,svg}',
	'vs/workbench/browser/media/singularity-icon.png',
	'vs/workbench/browser/parts/editor/media/letterpress*.svg',
	'vs/workbench/contrib/chat/browser/widget/media/chatPet/*.{gif,png}',
	'vs/workbench/contrib/welcomeGettingStarted/browser/media/singularity-logo.gif',
	'vs/workbench/contrib/welcomeGettingStarted/browser/media/singularity-logo-*.png',
	'vs/workbench/contrib/welcomeGettingStarted/browser/media/singularity-signin-bg.png',
	'vs/workbench/contrib/welcomeGettingStarted/browser/media/AwesomeLathusca.woff',
	'vs/workbench/contrib/welcomeGettingStarted/browser/media/AwesomeLathusca.ttf',
