...
async function main(buildDir?: string) {
	...
	// Singularity SDK ships platform-specific native binaries that npm only installs
	...
	for (const plat of ['darwin-x64', 'darwin-arm64']) {
		...
		const singularityExtensionNodeModules = path.join('Contents', 'Resources', 'app', 'extensions', 'singularity-chat', 'node_modules');
		// @github/copilot/sdk/prebuilds/{platform} (pty.node, spawn-helper)
		crossCopyPlatformDir(x64AppPath, arm64AppPath, path.join(singularityExtensionNodeModules, '@github', 'copilot', 'sdk', 'prebuilds', plat));
		// @github/copilot/sdk/ripgrep/bin/{platform} (ripgrep shim)
		crossCopyPlatformDir(x64AppPath, arm64AppPath, path.join(singularityExtensionNodeModules, '@github', 'copilot', 'sdk', 'ripgrep', 'bin', plat));
		// @github/copilot/sdk/tgrep/bin/{platform} (tgrep binary)
		crossCopyPlatformDir(x64AppPath, arm64AppPath, path.join(singularityExtensionNodeModules, '@github', 'copilot', 'sdk', 'tgrep', 'bin', plat));
		// @github/copilot/tgrep/bin/{platform} (tgrep binary)
		crossCopyPlatformDir(x64AppPath, arm64AppPath, path.join(singularityExtensionNodeModules, '@github', 'copilot', 'tgrep', 'bin', plat));
	}
	...
	await makeUniversalApp({
		...
		x64ArchFiles: '{*/kerberos.node,**/extensions/microsoft-authentication/dist/libmsalruntime.dylib,**/extensions/microsoft-authentication/dist/msal-node-runtime.node,**/node_modules/@github/copilot-darwin-*/**,**/node_modules/@github/copilot/prebuilds/darwin-*/*,**/node_modules/@github/copilot/tgrep/bin/darwin-*/*,**/node_modules/@github/copilot/sdk/tgrep/bin/darwin-*/*,**/node_modules.asar.unpacked/@github/copilot-darwin-*/**,**/node_modules.asar.unpacked/@github/copilot/prebuilds/darwin-*/*,**/node_modules.asar.unpacked/@github/copilot/tgrep/bin/darwin-*/*,**/node_modules.asar.unpacked/@github/copilot/sdk/tgrep/bin/darwin-*/*,**/extensions/singularity-chat/node_modules/@github/copilot/sdk/prebuilds/darwin-*/*,**/extensions/singularity-chat/node_modules/@github/copilot/sdk/ripgrep/bin/darwin-*/*,**/extensions/singularity-chat/node_modules/@github/copilot/sdk/tgrep/bin/darwin-*/*,**/extensions/singularity-chat/node_modules/@github/copilot/tgrep/bin/darwin-*/*,**/node_modules/@vscode/ripgrep-universal/bin/darwin-*/*,**/node_modules.asar.unpacked/@vscode/ripgrep-universal/bin/darwin-*/*,**/node_modules/@vscode/os-proxy-resolver-darwin-*/**,**/node_modules.asar.unpacked/@vscode/os-proxy-resolver-darwin-*/**,**/node_modules/@microsoft/mxc-sdk/bin/**,**/node_modules.asar.unpacked/@microsoft/mxc-sdk/bin/**}',
