...
const FILES_TO_SKIP = [
	...
	// Singularity SDK: universal app has both x64 and arm64 platform packages
	...
	// Singularity prebuilds: single-arch binaries in per-platform directories
	'**/node_modules/@github/copilot/prebuilds/darwin-*/**',
	'**/node_modules.asar.unpacked/@github/copilot/prebuilds/darwin-*/**',
	// Singularity SDK (extensions/singularity-chat): single-arch prebuilds and ripgrep binaries
	...
	// Singularity SDK tgrep prebuilds: single-arch binaries in per-platform directories
