...
Cette fonctionnalité désactive [les protections de sécurité critiques](https://code.visualstudio.com/docs/singularity/security) et facilite considérablement la compromission de la machine par un attaquant.`,
