...
//
// It clones the proven singularity VSIX background-download harness: a detached
...
//   * SHORT poll budget (not the singularity 30min): a missing artifact must degrade
...
// singularity 30min so a never-produced artifact degrades to fallback quickly, but
