...
Provider implementations (`agentHost`, `singularityChatSessions`, `remoteAgentHost`). These are the compute backends that register with `ISessionsProvidersService`.
