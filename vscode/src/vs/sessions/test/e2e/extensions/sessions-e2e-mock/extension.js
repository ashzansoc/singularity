...
/**
 * Registers mock command handlers that stand in for the real GitHub Singularity
...
function registerMockCommands(vscode) {
	...
	disposables.push(vscode.commands.registerCommand(
		'singularity.chat.chat.openPullRequestSingularityCLIAgentSession.openPR',
		() => {
	...
	disposables.push(vscode.commands.registerCommand(
		'singularity.chat.chat.mergeSingularityCLIAgentSessionChanges.merge',
		() => {
	...
	disposables.push(vscode.commands.registerCommand(
		'singularity.chat.chat.mergeSingularityCLIAgentSessionChanges.mergeAndSync',
		() => {
	...
	disposables.push(vscode.commands.registerCommand(
		'singularity.chat.chat.applySingularityCLIAgentSessionChanges.apply',
		() => {
	...
	disposables.push(vscode.commands.registerCommand(
		'singularity.chat.chat.checkoutPullRequestReroute',
		() => {
	...
	disposables.push(vscode.commands.registerCommand(
		'singularity.chat.chat.updateSingularityCLIAgentSessionChanges.update',
		() => {
