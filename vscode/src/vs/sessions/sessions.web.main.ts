...
// Singularity cloud sandbox connections (singularity-developer-cli) over a Web PubSub AHP relay
...
// Mobile-aware Singularity permission picker. Replaces the desktop
...
import './contrib/providers/singularityChatSessions/browser/mobilePermissionPicker.contribution.js';
