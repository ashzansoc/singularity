...
export class AgentHostInputCompletionHandler extends AgentHostInputCompletionsBase<void, string> {
	...
	constructor(
		...
		// provider* name (e.g. `singularitycli`), while content providers are
		// registered for the resource scheme (e.g. `agent-host-singularity` or
		// `remote-<host>-singularity`). Only the scheme matches the keys
