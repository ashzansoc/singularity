 ...
 * 'singularity-cli'), so callers need both to route session creation to the
 * right provider.
 */
...
export class SessionTypePicker extends Disposable {
	 ...
	 * the extension-host Singularity CLI once `chat.agents.singularityCli.hideExtensionHost`
