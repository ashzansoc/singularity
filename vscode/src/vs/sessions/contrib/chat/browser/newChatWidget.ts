...
export class NewChatWidget extends Disposable {
	...
	render(parent: HTMLElement): void {
		...
		// regular picker is always functional (the local Singularity provider
	 ...
	 * stopped being advertised — e.g. the extension-host Singularity CLI once
	 * `chat.agents.singularityCli.hideExtensionHost` is on. Keeping it would leave
