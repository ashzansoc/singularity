...
export class SessionsSingularityConfigSlashSubmitHandlerContribution extends Disposable implements IWorkbenchContribution {

	static readonly ID = 'sessions.contrib.chat.singularityConfigSlashSubmitHandler';
	...
	constructor(
		...
		this._register(submitRequestHandlerService.register({
			id: 'sessions.singularity.configSlash',
