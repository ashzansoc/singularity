...
import { SessionsSingularityConfigSlashSubmitHandlerContribution } from '../browser/singularityConfigSlashSubmitHandler.js';
...
class SelectAgentsFolderContribution extends Disposable implements IWorkbenchContribution {
	...
	private async resolveAndOpenSession(sessionResource: URI): Promise<void> {
		// The Singularity AI Sessions Provider lists sessions asynchronously
...
registerWorkbenchContribution2(SessionsSingularityConfigSlashSubmitHandlerContribution.ID, SessionsSingularityConfigSlashSubmitHandlerContribution, WorkbenchPhase.AfterRestored);
