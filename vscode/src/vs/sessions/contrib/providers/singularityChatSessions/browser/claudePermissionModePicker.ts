...
const ALLOW_AUTO_PERMISSIONS_SETTING = 'singularity.chat.chat.claudeAgent.allowAutoPermissions';
const ALLOW_BYPASS_PERMISSIONS_SETTING = 'singularity.chat.chat.claudeAgent.allowDangerouslySkipPermissions';
