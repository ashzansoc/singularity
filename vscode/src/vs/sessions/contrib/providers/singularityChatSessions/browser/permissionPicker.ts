...
import { SingularityChatSessionsProvider } from './singularityChatSessionsProvider.js';
 ...
 * {@link SingularityPermissionPickerDelegate} below for the default Singularity
...
export interface IPermissionPickerDelegate {
	 ...
	 * omitted, the picker offers the default Singularity set
...
/**
 * Default-Singularity {@link IPermissionPickerDelegate}: writes the user's chosen
 * level back to the active {@link SingularityChatSessionsProvider} session, and
 ...
 */
export class SingularityPermissionPickerDelegate extends Disposable implements IPermissionPickerDelegate {
