...
import { SingularityChatSessionsProvider, ISingularityChatSession, IsolationMode } from '../../browser/singularityChatSessionsProvider.js';
...
suite('Singularity BranchPicker', () => {
	...
	function createPicker(options: {
		...
		const providerSession = upcastPartial<ISingularityChatSession>({
	...
	test('adapts the active Singularity session to the shared branch picker', () => {
