...
suite('OpenSubagentChatActionViewItem', () => {
	...
	test('never shows which model a subagent used', () => {
		assert.deepStrictEqual([
			shouldShowSubagentModel(undefined, 'agent-host-singularitycli:gpt-5.6-sol', 'GPT-5.6 Sol', 'gpt-5.6-sol'),
			shouldShowSubagentModel('GPT-5.6 Sol', undefined, undefined, undefined),
			shouldShowSubagentModel('gpt-5.6-sol', 'agent-host-singularitycli:gpt-5.6-sol', 'GPT-5.6 Sol', 'gpt-5.6-sol'),
			shouldShowSubagentModel('GPT-5.6 Sol', 'agent-host-singularitycli:gpt-5.6-sol', 'GPT-5.6 Sol', 'gpt-5.6-sol'),
			shouldShowSubagentModel('Claude Opus 4.8', 'agent-host-singularitycli:gpt-5.6-sol', 'GPT-5.6 Sol', 'gpt-5.6-sol'),
		], [
			false,
			false,
			false,
