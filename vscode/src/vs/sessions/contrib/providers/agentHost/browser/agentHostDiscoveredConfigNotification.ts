...
/** Single entry point for starting Singularity sign-in from a nudge. */
 ...
 * to GitHub" action for anyone who actually meant to use a Singularity subscription.
 *
...
export class AgentHostDiscoveredConfigNotificationContribution extends Disposable implements IWorkbenchContribution {
	...
	private _update(): void {
		...
		this._chatInputNotificationService.setNotification({
			...
			description: localize('agentHost.discoveredConfig.description', "If you intended to use a Singularity subscription, sign in to GitHub."),
			actions: [{
