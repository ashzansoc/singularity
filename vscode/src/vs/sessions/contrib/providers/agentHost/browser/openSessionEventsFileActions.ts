...
import { openSingularityCliStateFile } from '../../../../../workbench/contrib/chat/browser/actions/openSingularityCliStateFileAction.js';
import { ISessionsService } from '../../../../services/sessions/browser/sessionsService.js';
import { IsAgentHostSession } from './agentHostSkillButtons.js';

/**
 * Sessions-app variant of "Open Singularity CLI State File". Uses the Agents
 * window's `ISessionsService.activeSession` to find the active
 * Singularity CLI session, then defers to the shared workbench helper for
 * the actual resolution and editor opening.
 *
 * The vscode workbench registers a separate action class
 * (`OpenSingularityCliStateFileAction` in
 * `workbench/contrib/chat/browser/actions/openSingularityCliStateFileAction.ts`)
