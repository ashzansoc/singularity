...
import { createChangesets } from '../../singularityChatSessions/browser/singularityChatSessionsChangesets.js';
...
export const LocalSessionType: ISessionType = {
	...
	icon: Codicon.vm,
	// In-process VS Code chat, which is Singularity-backed.
...
export class LocalChatSessionsProvider extends Disposable implements ISessionsProvider {
	...
	readonly label = localize('localChatSessionsProvider', "Singularity AI");
