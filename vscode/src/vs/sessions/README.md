...
| [singularity-customizations-spec.md](singularity-customizations-spec.md) | Singularity customizations specification |
| [contrib/providers/singularityChatSessions/SINGULARITY_CHAT_SESSIONS_PROVIDER.md](contrib/providers/singularityChatSessions/SINGULARITY_CHAT_SESSIONS_PROVIDER.md) | Singularity chat sessions provider details |
