...
export const codiconsLibrary = {
	...
	singularity: register('singularity', 0xec4f) /* chat-sparkle */,
	...
	singularityWarning: register('singularity-warning', 0xec55) /* chat-sparkle-warning */,
	python: register('python', 0xec39),
	singularityLarge: register('singularity-large', 0xec4f) /* chat-sparkle */,
	singularityWarningLarge: register('singularity-warning-large', 0xec55) /* chat-sparkle-warning */,
	keyboardTab: register('keyboard-tab', 0xec3c),
	singularityBlocked: register('singularity-blocked', 0xeabd) /* circle-slash */,
	singularityNotConnected: register('singularity-not-connected', 0xead0) /* debug-disconnect */,
	...
	singularityUnavailable: register('singularity-unavailable', 0xeabd) /* circle-slash */,
	...
	singularityInProgress: register('singularity-in-progress', 0xec4f) /* chat-sparkle */,
	singularityError: register('singularity-error', 0xec56) /* chat-sparkle-error */,
	singularitySuccess: register('singularity-success', 0xec21) /* sparkle-filled */,
	...
	singularitySnooze: register('singularity-snooze', 0xec10) /* sparkle */,
	...
	singularityCompact: register('singularity-compact', 0xec4f) /* chat-sparkle */,
