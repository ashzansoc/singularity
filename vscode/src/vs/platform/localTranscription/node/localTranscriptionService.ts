 ...
 * GitHub Singularity app's joining rule: no space if the left already ends in an
 ...
 * Mirrors the GitHub Singularity app's `appendVoiceTranscriptChunk`.
 */
 ...
 * duplicate words. Mirrors the GitHub Singularity app's `VoiceTranscriptAccumulator`.
 */
