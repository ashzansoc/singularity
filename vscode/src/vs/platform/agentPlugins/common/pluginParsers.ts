...
const SINGULARITY_FORMAT: IPluginFormatConfig = {
 ...
 * Singularity CLI camelCase, Claude PascalCase) to canonical identifiers.
 */
const HOOK_TYPE_MAP: Record<string, string> = {
	...
	// camelCase (GitHub Singularity CLI)
	'sessionStart': 'SessionStart',
	'sessionEnd': 'SessionEnd',
