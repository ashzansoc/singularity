 ...
 *
 * These mirror the shape used by the Singularity extension (kept in sync with
 * `extensions/singularity-chat/src/platform/otel/common/otelService.ts`) so the same
