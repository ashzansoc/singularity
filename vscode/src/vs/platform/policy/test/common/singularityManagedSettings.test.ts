...
import { collectManagedSettingsDefinitions, SINGULARITY_FORCE_REMOTE_SETTINGS_REFRESH_KEY, hasManagedSettingsDefinitions, managedSettingValue, projectManagedSettings, pickManagedSettings, shouldForceRemoteSettingsRefresh } from '../../common/singularityManagedSettings.js';
import { PolicyDefinition } from '../../common/policy.js';

suite('Singularity managed settings projection', () => {
	...
	test('forceRemoteSettingsRefresh uses native MDM over the cached server value', () => {
		assert.deepStrictEqual({
			serverTrue: shouldForceRemoteSettingsRefresh(undefined, { [SINGULARITY_FORCE_REMOTE_SETTINGS_REFRESH_KEY]: true }),
			nativeTrue: shouldForceRemoteSettingsRefresh({ [SINGULARITY_FORCE_REMOTE_SETTINGS_REFRESH_KEY]: true }, { [SINGULARITY_FORCE_REMOTE_SETTINGS_REFRESH_KEY]: false }),
			nativeFalse: shouldForceRemoteSettingsRefresh({ [SINGULARITY_FORCE_REMOTE_SETTINGS_REFRESH_KEY]: false }, { [SINGULARITY_FORCE_REMOTE_SETTINGS_REFRESH_KEY]: true }),
			malformedNative: shouldForceRemoteSettingsRefresh({ [SINGULARITY_FORCE_REMOTE_SETTINGS_REFRESH_KEY]: 'true' }, { [SINGULARITY_FORCE_REMOTE_SETTINGS_REFRESH_KEY]: true }),
...
suite('Singularity managed settings per-key precedence (pickManagedSettings)', () => {
