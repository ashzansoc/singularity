...
/**
 * Normalizes a raw CAPI or Singularity SDK billing payload into the camelCase
...
/**
 * Normalized model billing shape shared by CAPI-backed agents and the Singularity SDK model list.
