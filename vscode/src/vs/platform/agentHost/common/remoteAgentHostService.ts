...
/**
 * A connection to a Singularity cloud "sandbox" environment (agent integration slug
 * `singularity-developer-cli`), reached over a Mission Control-brokered Azure Web
