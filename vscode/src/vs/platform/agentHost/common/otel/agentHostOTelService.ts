 ...
 *  - **DB mode** (`SINGULARITY_OTEL_DB_SPAN_EXPORTER_ENABLED=true`): point the SDK at a
...
export interface IAgentHostOTelService {
	...
	/**
	 * Returns the telemetry config to hand to `new SingularityClient({ telemetry })`,
	 ...
	 * conversation id (e.g. the Singularity SDK conversation id or the Claude SDK
