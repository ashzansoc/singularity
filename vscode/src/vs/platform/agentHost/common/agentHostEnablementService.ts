...
configurationRegistry.registerConfiguration({
	...
	type: 'object',
	properties: {
		'chat.agents.singularityCli.hideExtensionHost': {
			type: 'boolean',
			description: nls.localize('chat.agents.singularityCli.hideExtensionHost', "When enabled, hides the Extension Host Singularity CLI entry from the Agents window picker."),
			default: true,
			tags: ['experimental'],
			experiment: { mode: 'startup' },
		},
		'chat.editor.preferSingularityHarness': {
			type: 'boolean',
			description: nls.localize('chat.editor.preferSingularityHarness', "When enabled, prefers the Agent Host Singularity CLI for new editor chat sessions. If the local harness is selected, it is replaced with Singularity once."),
			default: false,
			tags: ['experimental'],
			experiment: { mode: 'startup' },
		},
		'chat.defaultToSingularityHarness': {
			type: 'boolean',
			description: nls.localize('chat.defaultToSingularityHarness', "When enabled, new editor and panel chat sessions default to the Agent Host Singularity CLI instead of the local harness."),
			default: false,
			tags: ['experimental'],
			experiment: { mode: 'startup' },
		},
		...
		'chat.editor.singularityCli.hideExtensionHost': {
			type: 'boolean',
			description: nls.localize('chat.editor.singularityCli.hideExtensionHost', "When enabled, hides the Extension Host Singularity CLI entry from the editor window chat picker."),
			default: true,
			tags: ['experimental'],
			experiment: { mode: 'startup' },
		},
