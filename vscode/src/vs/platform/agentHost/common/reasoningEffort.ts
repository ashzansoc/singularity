 ...
 *
 * Consumers that need to recognize *any* advertised tier — notably the Singularity
 * launcher's `isSingularityReasoningEffort`, which decides what the model picker
 ...
 * - Singularity / Claude: `'low' | 'medium' | 'high' | 'xhigh' | 'max'`
 *
 ...
 * in `extensions/singularity-chat/src/extension/conversation/common/languageModelAccess.ts`
