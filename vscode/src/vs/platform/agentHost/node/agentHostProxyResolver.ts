 ...
 * per connected renderer) and consumed by {@link SingularityAgent} to resolve the
 * CAPI proxy through VS Code's Electron session before spawning the Singularity SDK.
 *
