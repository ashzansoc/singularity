...
import { ByokLmProxyService, IByokLmProxyService } from './singularity/byokLmProxyService.js';
...
// Sets up IPC, logging, and registers agent providers (Singularity).
...
async function startAgentHost(): Promise<void> {
	...
	try {
		...
		// SingularityApiService and the proxies that consume it are created AFTER the
