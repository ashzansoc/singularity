...
export function createSingularityCliEnvironment(environment: NodeJS.ProcessEnv = process.env): Record<string, string | undefined> {
	...
	env['SINGULARITY_CLI_RUN_AS_NODE'] = '1';
	env['USE_BUILTIN_RIPGREP'] = 'false';
	env['SINGULARITY_MCP_APPS'] = 'true';
