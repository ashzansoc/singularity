...
/* __GDPR__FRAGMENT__
	"SingularityCliForwardedTelemetry": {
		...
		"exp_assignment_context": { "classification": "SystemMetaData", "purpose": "FeatureInsight", "comment": "Experiment assignment context from the Singularity CLI runtime." },
		"session_id": { "classification": "SystemMetaData", "purpose": "FeatureInsight", "comment": "Identifier for the Singularity CLI session." },
		...
		"singularity_tracking_id": { "classification": "EndUserPseudonymizedInformation", "purpose": "BusinessInsight", "comment": "Pseudonymous Singularity user identifier supplied by the runtime." },
		"kind": { "classification": "SystemMetaData", "purpose": "FeatureInsight", "comment": "Kind of SDK telemetry event." },
		"cli_version": { "classification": "SystemMetaData", "purpose": "PerformanceAndHealth", "comment": "Version of the Singularity CLI runtime." },
		"os_platform": { "classification": "SystemMetaData", "purpose": "PerformanceAndHealth", "comment": "Operating system platform of the Singularity CLI runtime." },
		"os_version": { "classification": "SystemMetaData", "purpose": "PerformanceAndHealth", "comment": "Operating system version of the Singularity CLI runtime." },
		"os_arch": { "classification": "SystemMetaData", "purpose": "PerformanceAndHealth", "comment": "Operating system architecture of the Singularity CLI runtime." },
		"node_version": { "classification": "SystemMetaData", "purpose": "PerformanceAndHealth", "comment": "Node.js version of the Singularity CLI runtime." },
		"singularity_plan": { "classification": "SystemMetaData", "purpose": "FeatureInsight", "comment": "Singularity subscription plan reported by the runtime." },
		...
		"${wildcard}": [{
			"${prefix}": "feature.",
			"${classification}": { "classification": "SystemMetaData", "purpose": "FeatureInsight", "comment": "Feature flag value supplied by the Singularity CLI runtime." }
		}]
	}
*/

/* __GDPR__
	"singularityCli/response.success": {
		"owner": "amunger",
		"comment": "Reports performance and usage details for successful Singularity CLI model responses forwarded by the Singularity SDK.",
		"${include}": [ "${SingularityCliForwardedTelemetry}" ],
		...
		"singularity_pid": { "classification": "SystemMetaData", "purpose": "PerformanceAndHealth", "comment": "Process identifier for the Singularity CLI runtime." },
...
/* __GDPR__
	"singularityCli/response.error": {
		"owner": "amunger",
		"comment": "Reports performance and usage details for failed Singularity CLI model responses forwarded by the Singularity SDK.",
		"${include}": [ "${SingularityCliForwardedTelemetry}" ],
...
/* __GDPR__
	"singularityCli/task_complete_todo_state": {
		"owner": "amunger",
		"comment": "Reports the aggregate state of the Singularity CLI todo list when task completion is recorded. Contains only todo-status counts and derived boolean indicators; it does not contain todo text or other user content.",
		"${include}": [ "${SingularityCliForwardedTelemetry}" ],
		"singularity_pid": { "classification": "SystemMetaData", "purpose": "PerformanceAndHealth", "comment": "Process identifier for the Singularity CLI runtime." },
		"interaction_id": { "classification": "SystemMetaData", "purpose": "FeatureInsight", "comment": "Identifier that correlates events in an interaction." },
		"engagement_id": { "classification": "SystemMetaData", "purpose": "FeatureInsight", "comment": "Identifier that correlates events in an engagement." },
		...
		"had_todos": { "classification": "SystemMetaData", "purpose": "FeatureInsight", "comment": "Whether the Singularity CLI todo list contained at least one item when task completion was recorded." },
		"has_open_todos": { "classification": "SystemMetaData", "purpose": "FeatureInsight", "comment": "Whether the Singularity CLI todo list contained at least one pending, in-progress, or blocked item when task completion was recorded." },
...
/**
 * Re-emits GitHub-shaped telemetry events forwarded by the Singularity CLI runtime
 ...
 * restricted telemetry is enabled for the current Singularity token; standard
 * events always flow through.
 */
export class SingularityGitHubTelemetryForwarder {
	...
	forward(notification: GitHubTelemetryNotification): void {
		...
		const data: ITelemetryData = {
			...
			singularity_tracking_id: (event as { singularity_tracking_id?: string }).singularity_tracking_id,
			kind: event.kind,
		...
		this._telemetryService.publicLog(`singularityCli/${event.kind}`, data);
	}
}
