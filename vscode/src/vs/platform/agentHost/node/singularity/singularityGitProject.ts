...
export interface ISingularitySessionContext {
	readonly cwd?: string;
...
export async function projectFromSingularityContext(context: ISingularitySessionContext | undefined, gitService: IAgentHostGitService): Promise<IAgentSessionProjectInfo | undefined> {
