 ...
 */
export const SINGULARITY_AGENT_HOST_IDENTITY = 'You are an AI assistant using Singularity CLI runtime in VS Code. You help users with software engineering tasks. When asked about your identity, you must state that you are an AI assistant using Singularity CLI runtime in VS Code.';

/** Response-formatting contract for workspace links emitted by Agent Host models. */
export const SINGULARITY_AGENT_HOST_FILE_LINK_INSTRUCTIONS = [
...
/**
 * Default system-message customization applied to every Singularity CLI agent-host
 ...
 */
export const SINGULARITY_AGENT_HOST_SYSTEM_MESSAGE = {
	mode: 'customize',
	sections: {
		identity: {
			action: 'replace',
			content: SINGULARITY_AGENT_HOST_IDENTITY,
		},
	},
 ...
 */
export const SINGULARITY_AGENT_HOST_WORKSPACELESS_INSTRUCTIONS = [
	'<workspaceless_chat>',
