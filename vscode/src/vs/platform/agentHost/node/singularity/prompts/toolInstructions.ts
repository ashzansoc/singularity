 ...
 *
 * This is the agent-host home for the Singularity extension's `toolUseInstructions`
 ...
 * Singularity extension's `agenticBrowserTools`. Derived from the full reference-name
...
/**
 * Front-end guidance for the integrated browser tools, ported from the Singularity
...
/** Tool-search guidance mirrored from the Singularity extension prompt. */
