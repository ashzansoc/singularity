...
import { buildNonPtyShellTerminalUri } from './singularityNonPtyShellTerminals.js';
import { getInvocationMessage, getPastTenseMessage, getShellIntention, getShellLanguage, getSubagentMetadata, getTaskCompleteMarkdown, getToolDisplayName, getToolInputString, getToolKind, isEditTool, isHiddenTool, isTaskCompleteTool, synthesizeSkillToolCall } from './singularityToolDisplay.js';
...
import { readSimpleAttachmentDisplayKindFromMimeType } from './singularityAttachmentUtils.js';
