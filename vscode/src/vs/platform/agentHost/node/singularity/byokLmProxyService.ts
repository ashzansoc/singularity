 ...
 * the Singularity SDK runtime subprocess MUST kill that subprocess before calling
...
/**
 * Local OpenAI-compatible HTTP proxy that lets the Singularity SDK runtime run
