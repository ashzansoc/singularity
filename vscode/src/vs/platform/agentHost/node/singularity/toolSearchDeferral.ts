...
/**
 * Non-deferred client tools, mirroring the Singularity extension allowlist entries
...
/** Mirrors the Singularity extension's string-form `modelSupportsToolSearch`. */
