...
import { IAgentCreateChatOptions, IAgentCreateSessionConfig, IAgentHostExecutionTaskRequest, IAgentHostExecutionTaskResult, IAgentHostInspectInfo, IAgentHostManagedSettingsDiagnostics, IAgentHostManagementService, IAgentHostNetworkDiagnosticsInfo, IAgentHostNetworkFetchResult, IAgentHostSocketInfo, IAgentService, IConnectionTrackerService } from '../common/agentService.js';
...
export class AgentHostManagementService implements IAgentHostManagementService {
	...
	executeExecutionTask(request: IAgentHostExecutionTaskRequest): Promise<IAgentHostExecutionTaskResult> {
		return this._agentService.executeExecutionTask(request);
	}
}
