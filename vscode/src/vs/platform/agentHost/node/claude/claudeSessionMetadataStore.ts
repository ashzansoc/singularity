...
export class ClaudeSessionMetadataStore {
	 ...
	 * SingularityAgent's `_storeSessionMetadata` pattern
	 * (`singularityAgent.ts:1532`): single `openDatabase` ref, `Promise.all`
	 ...
	 * Mirrors SingularityAgent's `_readSessionMetadata` (`singularityAgent.ts:1559`)
