 ...
 *
 * Mirrors the shape of [singularityToolDisplay.ts](../singularity/singularityToolDisplay.ts)
 ...
 * renderer). Mirror of
 * [`singularityToolDisplay.getToolKind`](../singularity/singularityToolDisplay.ts).
 */
 ...
 * titles in {@link getPermissionDisplay} for SingularityAgent so both
 ...
 * resulting envelope stays minimal. Mirrors Singularity's
 * [`mapSessionEvents.ts:197`](../singularity/mapSessionEvents.ts#L197)
 ...
 * [`singularityToolDisplay.getInvocationMessage`](../singularity/singularityToolDisplay.ts#L473).
 */
 ...
 * [`singularityToolDisplay.getPastTenseMessage`](../singularity/singularityToolDisplay.ts#L572).
