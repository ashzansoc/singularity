 ...
 * loop in the Singularity `ActiveClient` staleness check.
 */
 ...
 * tool model shared by the agent-host providers (Singularity, Claude, Codex):
 ...
 * structural tool snapshot it contributes. Shared between the Singularity and
