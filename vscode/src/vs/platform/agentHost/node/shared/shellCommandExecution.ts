 ...
 * `<<<SINGULARITY_SENTINEL_<uuid>_EXIT_<code>>>`.
 */
const SENTINEL_PREFIX = '<<<SINGULARITY_SENTINEL_';
 ...
 *
 * This is the shared shell-integration primitive used by both the Singularity SDK
