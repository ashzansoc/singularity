...
import { DiscoveredType, type IDiscoveredDirectory } from '../singularity/sessionCustomizationDiscovery.js';
 ...
 * required because the Singularity SDK subprocess receives skill directories
