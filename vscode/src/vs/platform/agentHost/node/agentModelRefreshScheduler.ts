 ...
 *
 * Each refresh is a real network request (`models.list` through the Singularity CLI
 * for `singularitycli`, `GET /models` via `SingularityApiService` for the others). An
