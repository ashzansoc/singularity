...
import { deriveGitHubEndpoints, gitHubSingularityResource, gitHubRepoResource } from '../../common/githubEndpoints.js';
...
export function createTestGitHubEndpointService(enterpriseUri?: string): IAgentHostGitHubEndpointService {
	...
	return {
		...
		getSingularityResource: () => gitHubSingularityResource(endpoints),
