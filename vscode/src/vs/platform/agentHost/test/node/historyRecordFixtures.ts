...
import { getInvocationMessage, getPastTenseMessage, getShellLanguage, getSubagentMetadata, getToolDisplayName, getToolInputString, getToolKind, isEditTool, isHiddenTool, synthesizeSkillToolCall } from '../../node/singularity/singularityToolDisplay.js';
import { buildSessionDbUri } from '../../common/sessionDbUri.js';
import type { ISessionEvent, ISessionEventMessage, ISessionEventSkillInvoked, ISessionEventSubagentStarted, ISessionEventToolComplete, ISessionEventToolStart } from './singularityTestEvents.js';
...
// SDK-events-to-Turn[] pipeline in `node/singularity/mapSessionEvents.ts` runs
...
//
// Translates raw Singularity SDK session events into a flat IHistoryRecord
...
// fixtures captured from real `~/.singularity/session-state/` files can be
