...
export const SINGULARITY_CONFIG: IAgentHostE2EProviderConfig = {
	suiteTitle: 'Agent Host E2E — Singularity',
	...
	// `AGENT_HOST_REPLAY_RECORD=1`. The Singularity CLI is always present (dev dep).
	enabled: true,
