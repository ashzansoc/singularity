 ...
 * token`. Either works — the agent host's `SingularityApiService` discovers the
 * user's CAPI endpoint via `GET /singularity_internal/user` and uses the GitHub
...
const CLAUDE_CONFIG: IAgentHostE2EProviderConfig = {
	...
	// shared test's Singularity-flavoured prompt doesn't reliably drive Claude
