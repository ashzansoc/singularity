...
<skill>
  ...
  <description>Skill for customizing the Singularity cloud agent (formerly known as Singularity coding agent) environment, including singularity-setup-steps.yml configuration, preinstalling tools and dependencies, runners, and settings. Use when the user mentions singularity-setup-steps, singularity setup steps, or wants to configure the cloud agent environment.</description>
...
<session_context>
Session folder: ${homedir}/.singularity/session-state/${session_id}
...
Co-authored-by: Singularity <223556219+Singularity@users.noreply.github.com>
</git_commit_trailer>
<tool_calling>
