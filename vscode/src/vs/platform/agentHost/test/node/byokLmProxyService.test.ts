...
import { ByokLmProxyService, type IByokLmProxyHandle } from '../../node/singularity/byokLmProxyService.js';

/**
 * Exercises the inference path end-to-end without the Singularity SDK runtime:
