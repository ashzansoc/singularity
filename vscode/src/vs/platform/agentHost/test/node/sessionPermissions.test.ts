...
suite('SessionPermissionManager', () => {
	...
	const sessionUri = URI.from({ scheme: 'singularity', path: '/s' }).toString();
	...
	test('requires confirmation for home-directory dotfiles', async () => {
		const homeSession = URI.from({ scheme: 'singularity', path: '/home' }).toString();
	...
	test('requires confirmation when the working directory is not a file URI', async () => {
		const remoteSessionUri = URI.from({ scheme: 'singularity', path: '/remote' }).toString();
	...
	test('auto-approves reads when the working directory is itself symlinked', async () => {
		...
		const linkedSessionUri = URI.from({ scheme: 'singularity', path: '/linked' }).toString();
	...
	suite('multi-root', () => {
		const multiUri = URI.from({ scheme: 'singularity', path: '/multi' }).toString();
