...
import { buildSandboxConfigForSdk, type IAgentSandboxFileSystemSetting } from '../../node/singularity/sandboxConfigForSdk.js';
 ...
 *
 * Mirrors the per-OS dispatch in the Singularity extension's
