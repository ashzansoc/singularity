...
import { CopilotClient as SingularityClient } from '@github/copilot-sdk';
...
import { ByokLmProxyService } from '../../../node/singularity/byokLmProxyService.js';
import { createSingularityCliEnvironment } from '../../../node/singularity/singularityCliEnvironment.js';

suite('Agent Host Provider Integration - Singularity BYOK Responses', function () {
	...
	test('bundled SDK consumes structured reasoning and text from the proxy', async function () {
		...
		let session: Awaited<ReturnType<SingularityClient['createSession']>> | undefined;
