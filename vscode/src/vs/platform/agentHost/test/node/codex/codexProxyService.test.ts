...
class FakeSingularityApiService implements ISingularityApiService {
	...
	readonly modelsCalls: { githubToken: string; options: ISingularityApiServiceRequestOptions | undefined }[] = [];
	...
	async responses(githubToken: string, body: string, options?: ISingularityApiServiceRequestOptions): Promise<Response> {
...
suite('CodexProxyService', () => {
	...
	async function withProxy(fn: (handle: { baseUrl: string; nonce: string }, fake: FakeSingularityApiService) => Promise<void>): Promise<void> {
