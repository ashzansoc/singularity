...
export interface IModalEditorOptions {
	...
	/**
	 * Fraction of the available workbench size used for the default
	 * (non-maximized) modal. Defaults to 0.8 when omitted.
	 */
	readonly sizeRatio?: number;

	/**
	 * When true, the modal backdrop blurs the workbench behind it.
	 */
