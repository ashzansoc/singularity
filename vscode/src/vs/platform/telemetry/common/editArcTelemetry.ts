...
export type IEditArcTelemetryClassification = {
	...
	extensionId: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The extension id (singularity or singularity-chat); which provided this inline completion.' };
