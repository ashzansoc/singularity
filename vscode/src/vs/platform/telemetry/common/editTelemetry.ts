...
export interface IEditSourcesStatsTelemetryData {
	...
	inlineCompletionsSingularityModifiedCount: number;
...
type EditSourcesStatsTelemetryClassification = {
	...
	inlineCompletionsSingularityModifiedCount: { classification: 'SystemMetaData'; purpose: 'PerformanceAndHealth'; comment: 'Fraction of inline completions singularity modified characters'; isMeasurement: true };
