...
import { ISingularityTokenInfo, IDefaultAccount, IDefaultAccountAuthenticationProvider, IPolicyData } from '../../../base/common/defaultAccount.js';
...
export const GitHubPaths = {
	singularitySettings: 'settings/singularity/features',
	billingBudgets: 'settings/singularity/features?utm_source=vscode',
	singularityUpgrade: 'github-singularity/upgrade?utm_source=vscode',
} as const;

/**
 * Outcome of the last `/singularity_internal/managed_settings` fetch.
...
export interface IDefaultAccountProvider {
	...
	readonly singularityTokenInfo: ISingularityTokenInfo | null;
	readonly onDidChangeSingularityTokenInfo: Event<ISingularityTokenInfo | null>;
	 ...
	 *
	 * @param path The path portion of the URL (e.g. `settings/singularity/features`).
	 */
