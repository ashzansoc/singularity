 ...
 * session, following the `github_singularity_<surface>` form asked of every GitHub
 * Singularity surface. Must stay stable: it is a wire contract with the reporting
 ...
 */
export const AiAgentEnvValue = 'github_singularity_vscode_agent';
