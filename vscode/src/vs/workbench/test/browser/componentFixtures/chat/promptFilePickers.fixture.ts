		...
		render: context => renderPromptFilePickerFixture({
			...
			seedData: promptsService => {
				...
				promptsService.userPromptFiles = [
					{ uri: URI.file('/home/dev/.singularity/prompts/review.prompt.md'), storage: PromptsStorage.user, type: PromptsType.prompt, name: 'Review Prompt', description: 'Review this change' },
				];
			},
		}),
	}),
