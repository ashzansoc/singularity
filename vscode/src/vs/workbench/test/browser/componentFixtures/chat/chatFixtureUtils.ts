...
import { IPlanTodoSyncService } from '../../../../contrib/chat/common/plan/planTodoSyncService.js';
...
export function registerChatFixtureServices(reg: ServiceRegistration, options: IChatFixtureServicesOptions = {}): void {
	...
	reg.define(IChatAgentService, class FixtureChatAgentService extends ChatAgentService {
		override getDefaultAgent(): IChatAgent {
			...
			return { fullName: 'Singularity', id: 'githubSingularity' } as unknown as IChatAgent;
		}
	});
	...
	reg.defineInstance(IPlanTodoSyncService, new class extends mock<IPlanTodoSyncService>() {
		override readonly onDidChangePlanUri = Event.None;
		override bindPlanUri() { }
		override getPlanUri() { return undefined; }
		override syncPlanToChatTodos() { }
		override notifyPlanFileChanged() { }
		override async syncChatTodosToPlanFile() { }
		override async syncPlanFileToChatTodos() { }
	}());
}
