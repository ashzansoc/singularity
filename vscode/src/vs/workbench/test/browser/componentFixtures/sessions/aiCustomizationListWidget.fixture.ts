...
export default defineThemedFixtureGroup({ path: 'chat/aiCustomizations/' }, {
	...
	InstructionsTabWithItems: defineComponentFixture({
		...
		render: ctx => renderInstructionsTab(ctx, [
			...
			{ promptPath: { uri: URI.file('/home/dev/.singularity/instructions/my-style.instructions.md'), storage: PromptsStorage.user, type: PromptsType.instructions }, name: 'My Style', description: 'Personal coding style preferences' },
			...
			{ promptPath: { uri: URI.file('/home/dev/.singularity/instructions/typescript-rules.instructions.md'), storage: PromptsStorage.extension, type: PromptsType.instructions, extension: undefined!, source: undefined! }, name: 'TypeScript Rules', description: 'TypeScript conventions', applyTo: '**/*.ts' },
		], [
			// Agent instruction files (AGENTS.md, singularity-instructions.md)
