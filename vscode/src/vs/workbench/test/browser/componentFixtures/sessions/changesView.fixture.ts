...
const SAMPLE_OTHER_FILES = [
	...
	createOtherFile('/home/user/.config/singularity/agents/inbox.agent.md', SessionFileOperation.Created),
	createOtherFile('/home/user/.cache/singularity/session.log', SessionFileOperation.Deleted),
	...
	createOtherFile('/home/user/.local/share/singularity/state.json', SessionFileOperation.Created),
