...
function createMockPromptsService(files: IFixtureFile[], agentInstructions: IAgentInstructionFile[], contents: ResourceMap<string>, onDidChangeFiles: Event<void>): IPromptsService {
	...
	const skillSourceFolders: IResolvedPromptSourceFolder[] = [
		...
		{ uri: URI.file('/home/dev/.singularity/skills'), searchRoot: URI.file('/home/dev/.singularity/skills'), filePattern: undefined, source: PromptFileSource.SingularityPersonal, storage: PromptsStorage.user },
...
// ============================================================================
// Realistic test data — a project that has Singularity + Claude customizations
// ============================================================================

const allFiles: IFixtureFile[] = [
	// Instructions - extension (built-in + third-party)
	{ uri: URI.file('/extensions/singularity.chat-chat/instructions/coding.instructions.md'), storage: PromptsStorage.extension, type: PromptsType.instructions, name: 'Singularity Coding', description: 'Built-in coding guidance', extensionId: 'Singularity.singularity-chat', extensionDisplayName: 'Singularity AI' },
	...
	// Instructions — user
	{ uri: URI.file('/home/dev/.singularity/instructions/my-style.instructions.md'), storage: PromptsStorage.user, type: PromptsType.instructions, name: 'My Style', description: 'Personal coding style' },
	{ uri: URI.file('/home/dev/.singularity/instructions/typescript-rules.instructions.md'), storage: PromptsStorage.user, type: PromptsType.instructions, name: 'TypeScript Rules', description: 'Strict TypeScript conventions' },
	{ uri: URI.file('/home/dev/.singularity/instructions/commit-messages.instructions.md'), storage: PromptsStorage.user, type: PromptsType.instructions, name: 'Commit Messages', description: 'Conventional commit format' },
	...
	// Agents — user
	{ uri: URI.file('/home/dev/.singularity/agents/planner.agent.md'), storage: PromptsStorage.user, type: PromptsType.agent, name: 'Planner', description: 'Project planning agent' },
	{ uri: URI.file('/home/dev/.singularity/agents/debugger.agent.md'), storage: PromptsStorage.user, type: PromptsType.agent, name: 'Debugger', description: 'Interactive debugging assistant' },
	{ uri: URI.file('/home/dev/.singularity/agents/nls-helper.agent.md'), storage: PromptsStorage.user, type: PromptsType.agent, name: 'NLS Helper', description: 'Natural language searching code for clarity' },
	// Agents - extension (built-in + third-party)
	{ uri: URI.file('/extensions/singularity.chat-chat/agents/workspace-guide.agent.md'), storage: PromptsStorage.extension, type: PromptsType.agent, name: 'Workspace Guide', description: 'Built-in workspace exploration agent', extensionId: 'Singularity.singularity-chat', extensionDisplayName: 'Singularity AI' },
	...
	// Skills — user
	{ uri: URI.file('/home/dev/.singularity/skills/git-workflow/SKILL.md'), storage: PromptsStorage.user, type: PromptsType.skill, name: 'Git Workflow', description: 'Branch and PR workflows' },
	{ uri: URI.file('/home/dev/.singularity/skills/code-review/SKILL.md'), storage: PromptsStorage.user, type: PromptsType.skill, name: 'Code Review', description: 'Structured code review checklist' },
	// Skills - extension (built-in + third-party)
	{ uri: URI.file('/extensions/singularity.chat-chat/skills/workspace/SKILL.md'), storage: PromptsStorage.extension, type: PromptsType.skill, name: 'Workspace Search', description: 'Built-in workspace search skill', extensionId: 'Singularity.singularity-chat', extensionDisplayName: 'Singularity AI' },
	...
	// Prompts — user
	{ uri: URI.file('/home/dev/.singularity/prompts/translate.prompt.md'), storage: PromptsStorage.user, type: PromptsType.prompt, name: 'Translate', description: 'Translate strings for i18n' },
	{ uri: URI.file('/home/dev/.singularity/prompts/commit-msg.prompt.md'), storage: PromptsStorage.user, type: PromptsType.prompt, name: 'Commit Message', description: 'Generate conventional commit' },
	// Prompts - extension (built-in + third-party)
	{ uri: URI.file('/extensions/singularity.chat-chat/prompts/trace.prompt.md'), storage: PromptsStorage.extension, type: PromptsType.prompt, name: 'Trace', description: 'Built-in tracing prompt', extensionId: 'Singularity.singularity-chat', extensionDisplayName: 'Singularity AI' },
	...
	// Hooks — user
	{ uri: URI.file('/home/dev/.singularity/hooks/daily-summary.json'), storage: PromptsStorage.user, type: PromptsType.hook, name: 'Daily Summary', description: 'Generate daily work summary' },
	{ uri: URI.file('/home/dev/.singularity/hooks/backup-changes.json'), storage: PromptsStorage.user, type: PromptsType.hook, name: 'Backup Changes', description: 'Auto-stash uncommitted changes' },
];
...
const agentInstructions: IAgentInstructionFile[] = [
	...
	{ uri: URI.file('/workspace/.github/singularity-instructions.md'), realPath: undefined, type: AgentInstructionFileType.singularityInstructionsMd },
];
...
const mcpRuntimeServers = [
	{ definition: { id: 'github-singularity-mcp', label: 'Singularity' }, collection: { id: 'ext.singularity.chat/mcp', label: 'ext.singularity.chat/mcp' }, enablement: constObservable(ContributionEnablementState.EnabledProfile), connectionState: constObservable({ state: McpConnectionState.Kind.Starting }), showOutput() { } },
...
async function renderEditor(ctx: ComponentFixtureContext, options: IRenderEditorOptions): Promise<void> {
	...
	const availableHarnesses = options.availableHarnesses ?? [
		...
		{
			id: 'agent-host-singularitycli',
			label: 'Singularity [Agent Host]',
		...
		additionalServices: (reg) => {
			...
			reg.defineInstance(IProductService, new class extends mock<IProductService>() {
				override readonly defaultChatAgent = new class extends mock<NonNullable<IProductService['defaultChatAgent']>>() {
					override readonly chatExtensionId = 'Singularity.singularity-chat';
				}();
			}());
		},
	});
...
function makeInstalledPlugin(name: string, uri: URI, enabled: boolean): IAgentPlugin {
	return new class extends mock<IAgentPlugin>() {
		...
		override readonly format = PluginFormat.Singularity;
...
const installedPlugins: IAgentPlugin[] = [
	makeInstalledPlugin('Linear', URI.file('/workspace/.singularity/plugins/linear'), true),
	makeInstalledPlugin('Sentry', URI.file('/workspace/.singularity/plugins/sentry'), true),
	makeInstalledPlugin('Datadog', URI.file('/workspace/.singularity/plugins/datadog'), true),
	makeInstalledPlugin('Notion', URI.file('/workspace/.singularity/plugins/notion'), true),
	makeInstalledPlugin('Confluence', URI.file('/workspace/.singularity/plugins/confluence'), true),
	makeInstalledPlugin('PagerDuty', URI.file('/workspace/.singularity/plugins/pagerduty'), false),
	makeInstalledPlugin('LaunchDarkly', URI.file('/workspace/.singularity/plugins/launchdarkly'), true),
	makeInstalledPlugin('CircleCI', URI.file('/workspace/.singularity/plugins/circleci'), true),
	makeInstalledPlugin('Vercel', URI.file('/workspace/.singularity/plugins/vercel'), false),
	makeInstalledPlugin('Supabase', URI.file('/workspace/.singularity/plugins/supabase'), true),
];
...
function makeMarketplacePlugin(name: string, description: string, repo: string): IMarketplacePlugin {
	return {
		...
		marketplaceType: MarketplaceType.Singularity,
	};
}
...
function makeInstalledPluginItem(name: string, description: string): IAgentPluginItem {
	return {
		...
		description,
		marketplace: 'GitHub',
		plugin: makeInstalledPlugin(name, URI.file(`/workspace/.singularity/plugins/${name.toLowerCase()}`), true),
	};
}
...
const agentHostSingularitySessionResource = URI.from({ scheme: 'agent-host-singularitycli', path: '/fixture-session' });
...
export default defineThemedFixtureGroup({ path: 'chat/aiCustomizations/' }, {
	...
	AgentHostPromptMigration: defineComponentFixture({
		...
		render: ctx => renderEditor(ctx, {
			sessionResource: agentHostSingularitySessionResource,
		}),
	}),
