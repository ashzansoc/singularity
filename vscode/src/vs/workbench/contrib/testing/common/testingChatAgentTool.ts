...
export class RunTestTool implements IToolImpl {
	...
	public static readonly DEFINITION: IToolData = {
		...
		tags: [
			...
			'enable_other_tool_singularity_readFile',
			'enable_other_tool_singularity_listDirectory',
			'enable_other_tool_singularity_findFiles',
			'enable_other_tool_singularity_runTests',
			'enable_other_tool_singularity_runTestsWithCoverage',
...
export class TestFailureTool implements IToolImpl {
	...
	public static readonly DEFINITION: IToolData = {
		...
		legacyToolReferenceFullNames: ['singularity_testFailure'],
