...
export namespace ChatMode {
	export const Ask = new BuiltinChatMode(ChatModeKind.Ask, 'Ask', localize('chatDescription', "Ask about your code — explain, explore, no edits"), Codicon.question);
	export const Edit = new BuiltinChatMode(ChatModeKind.Edit, 'Edit', localize('editsDescription', "Rewrite, optimize, or refactor the selection"), Codicon.edit);
	export const Agent = new BuiltinChatMode(ChatModeKind.Agent, 'Agent', localize('agentDescription', "Plan, Build, / for skills, @ for context"), Codicon.agent);
}
