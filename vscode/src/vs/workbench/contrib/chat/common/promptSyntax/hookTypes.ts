...
export const HOOKS_BY_TARGET: Record<Target, Record<string, HookType>> = {
	// see https://code.visualstudio.com/docs/singularity/customization/hooks#_hook-lifecycle-events
	[Target.VSCode]: {
	...
	// see https://docs.github.com/en/singularity/concepts/agents/coding-agent/about-hooks#types-of-hooks
	[Target.Singularity]: {
		'sessionStart': HookType.SessionStart,
