...
export namespace PromptsConfig {
	...
	/**
	 * Configuration key for use of the singularity instructions file.
	 */
	export const USE_SINGULARITY_INSTRUCTION_FILES = 'singularity.chat.chat.codeGeneration.useInstructionFiles';
