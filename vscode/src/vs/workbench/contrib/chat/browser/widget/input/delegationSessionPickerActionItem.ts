...
export class DelegationSessionPickerActionItem extends SessionTypePickerActionItem {
	...
	protected override _isVisible(type: AgentSessionTarget): boolean {
		...
		if (this._isSessionsWindow && type === AgentSessionProviders.Background && this.chatSessionsService.getChatSessionContribution(AgentSessionProviders.AgentHostSingularity)) {
			return false;
		}
