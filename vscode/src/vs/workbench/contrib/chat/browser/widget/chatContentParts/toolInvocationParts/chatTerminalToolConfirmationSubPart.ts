...
export class ChatTerminalToolConfirmationSubPart extends BaseChatToolInvocationSubPart {
	...
	constructor(
		...
		// Agent Host Singularity confirmations need client-generated persistent rule actions.
		if (autoApproveEnabled && !customActions && terminalData.autoApproveRuleResolvable && getChatSessionType(this.context.element.sessionResource) === SessionType.AgentHostSingularity) {
