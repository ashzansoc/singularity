...
import { formatSingularityCredits, IChatHookPart, IChatMarkdownContent, IChatToolInvocation, IChatToolInvocationSerialized, isLegacyChatTerminalToolInvocationData } from '../../../common/chatService/chatService.js';
...
export class ChatSubagentContentPart extends ChatCollapsibleContentPart implements IChatContentPart {
	...
	// Singularity credits (AIC) consumed by this subagent, shown in the hover tooltip
	...
	private updateHover(): void {
		...
		if (typeof this.credits === 'number' && this.credits > 0) {
			const formatted = formatSingularityCredits(this.credits);
