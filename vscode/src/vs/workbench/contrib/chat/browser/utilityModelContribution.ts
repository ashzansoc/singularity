...
import { SINGULARITY_VENDOR_ID, ILanguageModelsService } from '../common/languageModels.js';
...
// Singularity main model, or no model for BYOK unless the user opts in.
 ...
 * setting. Selecting a model here overrides the internal `singularity-utility`
...
export class UtilityModelContribution extends DefaultModelContribution {
	...
	constructor(
		...
		super(utilityArrays, {
			...
			filter: metadata => metadata.vendor !== SINGULARITY_VENDOR_ID,
 ...
 * internal `singularity-utility-small` family used for fast/cheap background
