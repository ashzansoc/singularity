...
export class ChatViewTitleControl extends Disposable {
	...
	private doUpdate(): void {
		...
		const plainTitle = renderAsPlaintext(markdownTitle);
		this.title = plainTitle || (this.model ? localize('singularity.newAgentSession', "New Agent") : undefined);
	...
	private shouldRender(): boolean {
		// Singularity: keep the floating in-chat "New Agent" title row hidden.
		return false;
	}
