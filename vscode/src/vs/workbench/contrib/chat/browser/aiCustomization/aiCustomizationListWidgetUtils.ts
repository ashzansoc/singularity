 ...
 * extensions like Singularity AI that materialize prompt files under their
 * own globalStorage and register them via the prompt-file provider API.
 *
 * Returns the extension ID (e.g. `singularity.chat-chat`) or `undefined`
...
export function extractExtensionIdFromPath(uriPath: string): string | undefined {
	...
	// e.g. "singularity.chat-chat-0.43.2026040602" → "singularity.chat-chat"
