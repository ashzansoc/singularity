	...
	private updateSectionHeader(): void {
		...
		switch (this.currentSection) {
			...
			case AICustomizationManagementSection.Skills:
				...
				description = localize('skillsDescription', "Folders of instructions, scripts, and resources that Singularity loads when relevant to perform specialized tasks.");
	...
	private groupMatchedItems(matchedItems: IAICustomizationListItem[]): void {
		...
		const groups: { groupKey: string; label: string; icon: ThemeIcon; description: string; items: IAICustomizationListItem[] }[] =
			this.currentSection === AICustomizationManagementSection.Instructions
				? [
					{ groupKey: 'agent-instructions', label: localize('agentInstructionsGroup', "Agent Instructions"), icon: instructionsIcon, description: localize('agentInstructionsGroupDescription', "Instruction files automatically loaded for all agent interactions (e.g. AGENTS.md, CLAUDE.md, singularity-instructions.md)."), items: [] },
		...
		switch (this.currentSection) {
			...
			case AICustomizationManagementSection.Instructions:
				return {
					...
					description: localize('createFirstInstructions', "Add instructions to teach Singularity about your codebase"),
				};
			case AICustomizationManagementSection.Hooks:
				return {
