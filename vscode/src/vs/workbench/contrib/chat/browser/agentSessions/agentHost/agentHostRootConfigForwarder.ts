...
import { SingularityCliConfigKey } from '../../../../../../platform/agentHost/common/singularityCliConfig.js';
...
export interface IForwardedRootConfigKey {
	...
	readonly key: AgentHostConfigKey | SingularityCliConfigKey;
 ...
 * `AgentHostTerminalContribution` and `AgentHostSingularityCliSettingsContribution`
...
export class AgentHostRootConfigForwarder extends Disposable {
	 ...
	 */
	private readonly _schemaSeen = new Set<AgentHostConfigKey | SingularityCliConfigKey>();
	...
	private _schemaHasKey(key: AgentHostConfigKey | SingularityCliConfigKey): boolean {
