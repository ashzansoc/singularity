...
/**
 * The Singularity CLI agent-host session type. Tool enablement is scoped per session type; this is the
 * only target for the Chat Customizations → Tools section today.
 */
export const AGENT_HOST_SINGULARITY_CLI_SESSION_TYPE = 'agent-host-singularitycli';
