 ...
 * 1. Default state: Singularity icon pill (turns blue with in-progress count when agents are running)
...
export class AgentTitleBarStatusWidget extends BaseActionViewItem {
	...
	private _renderChatInputMode(disposables: DisposableStore): void {
		...
		const hoverLabel = localize('askAnythingPlaceholder', "Ask Singularity anything or describe what to build");
