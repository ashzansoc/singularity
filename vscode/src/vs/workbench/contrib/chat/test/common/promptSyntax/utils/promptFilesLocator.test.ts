...
suite('PromptFilesLocator', () => {
	...
	testT('core logic', async () => {
		...
		await mockFiles(fileService, [
			...
			{
				path: '/Users/legomushroom/repos/vscode/.singularity/prompts/default.prompt.md',
				contents: ['oh hi, robot!'],
			},
			{
		...
		assertOutcome(
			...
			[
				...
				'/Users/legomushroom/repos/prompts/refactor-tests.prompt.md',
				'/tmp/prompts/translate.to-rust.prompt.md',
				'/Users/legomushroom/repos/vscode/.singularity/prompts/default.prompt.md',
			],
			'Must find correct prompts.',
		);
	});
		...
		suite('core logic', () => {
			testT('without top-level `.github` folder', async () => {
				...
				await mockFiles(fileService, [
					...
					{
						path: '/Users/legomushroom/repos/vscode/.singularity/prompts/prompt1.prompt.md',
						contents: ['oh hi, robot!'],
					},
					{
					...
					{
						path: '/Users/legomushroom/repos/node/.singularity/prompts/prompt5.prompt.md',
						contents: ['oh hi, robot!'],
					},
					{
			...
			suite('absolute', () => {
				...
				testT(`specific`, async () => {
					const testSettings = [
						...
						[
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/my.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/*specific*',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/*common*',
						],
						[
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/my.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/*specific*.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/*common*.prompt.md',
						],
						[
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/my*.md',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/*specific*.md',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/*common*.md',
						],
						[
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/my*.md',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/specific*',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/unspecific*',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/common*',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/uncommon*',
						],
						[
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/my.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/specific.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/unspecific1.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/unspecific2.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/common.prompt.md',
							'/Users/legomushroom/repos/{prompts,vscode,singularity}/{gen,general}/**/uncommon-10.prompt.md',
						],
					];
	...
	suite('instructions', () => {
		testT('finds instructions files in subdirectories of .github/instructions', async () => {
			setLocations({
				...
				'.claude/rules': false,
				'~/.singularity/instructions': false,
			});
			setWorkspaceFolders(['/Users/legomushroom/repos/vscode']);
			await mockFiles(fileService, [
				{
			...
			testT('includes default skill source folders from defaults', async () => {
				...
				assertOutcome(
					...
					[
						...
						'/Users/legomushroom/.singularity/skills',
	...
	suite('getHookSourceFolders', () => {
		testT('returns source metadata for hook folders', async () => {
			...
			assert.deepStrictEqual(
				...
				[
					...
					{ path: '/Users/legomushroom/.singularity/hooks', source: PromptFileSource.SingularityPersonal, storage: PromptsStorage.user },
				],
			);
		});
		...
		testT('excludes Claude paths', async () => {
			...
			assert.deepStrictEqual(paths, [
				...
				'/Users/legomushroom/.singularity/hooks',
			]);
		});
	});
	...
	suite('listFiles with PromptsType.hook', () => {
		...
		testT('returns hook files from user home specific json paths', async () => {
			...
			await mockFiles(fileService, [
				...
				{ path: '/Users/legomushroom/.singularity/hooks/my-hook.json', contents: ['{}'] },
			]);
			const locator = instantiationService.createInstance(PromptFilesLocator);
			...
			assert.deepStrictEqual(
				...
				[
					...
					'/Users/legomushroom/.singularity/hooks/my-hook.json',
				],
			);
		});
	});
	...
	suite('getSourceDescription', () => {
		test('returns descriptions for all known folder sources', () => {
			const folderSources: PromptFileSource[] = [
				...
				PromptFileSource.SingularityPersonal,
