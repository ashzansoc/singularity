...
suite('promptFileLocations', function () {
	...
	suite('getPromptFileType', () => {
		...
		test('.md files in ~/.singularity/agents/ subfolder should NOT be recognized as agent files', () => {
			const uri = URI.file('/home/user/.singularity/agents/subfolder/test.md');
			assert.strictEqual(getPromptFileType(uri), undefined);
		});
		...
		test('.md files in ~/.singularity/agents/ folder should be recognized as agent files', () => {
			const uri = URI.file('/home/user/.singularity/agents/my-agent.md');
			assert.strictEqual(getPromptFileType(uri), PromptsType.agent);
		});

		test('README.md in ~/.singularity/agents/ should NOT be recognized as agent file', () => {
			const uri = URI.file('/home/user/.singularity/agents/README.md');
			assert.strictEqual(getPromptFileType(uri), undefined);
		});
		...
		test('singularity-instructions.md should be recognized as instructions', () => {
	...
	suite('getCleanPromptName', () => {
		...
		test('removes .md extension for files in ~/.singularity/agents/', () => {
			const uri = URI.file('/home/user/.singularity/agents/my-agent.md');
		...
		test('removes .md extension for singularity-instructions.md', () => {
			const uri = URI.file('/workspace/.github/singularity-instructions.md');
			assert.strictEqual(getCleanPromptName(uri), 'singularity-instructions');
		});
