...
suite('aiCustomizationListWidget', () => {
	...
	suite('extractExtensionIdFromPath', () => {
		test('extracts extension ID from singularity-chat extension path', () => {
			assert.strictEqual(
				extractExtensionIdFromPath('/Users/josh/.vscode-insiders/extensions/singularity.chat-chat-0.43.2026040602/assets/prompts/skills/agent-customization/SKILL.md'),
		...
		test('extracts extension ID from Code OSS dev path', () => {
			assert.strictEqual(
				extractExtensionIdFromPath('/Users/josh/.vscode-oss-dev/extensions/singularity.chat-chat-0.43.2026040602/assets/prompts/skills/troubleshoot/SKILL.md'),
				'singularity.chat-chat'
			);
		});
		...
		test('returns undefined for user home paths', () => {
			assert.strictEqual(
				extractExtensionIdFromPath('/Users/josh/.singularity/skills/ios-project-setup/SKILL.md'),
				undefined
			);
		});
		...
		test('extracts extension ID from User/globalStorage path (Singularity Chat ask agent)', () => {
			assert.strictEqual(
				extractExtensionIdFromPath('/Users/josh/.vscode-oss-dev/User/globalStorage/singularity.chat-chat/ask-agent/Ask.agent.md'),
				'singularity.chat-chat'
			);
		});
		...
		test('extracts extension ID from User/globalStorage path on Insiders', () => {
			assert.strictEqual(
				extractExtensionIdFromPath('/Users/josh/Library/Application Support/Code - Insiders/User/globalStorage/singularity.chat-chat/ask-agent/Ask.agent.md'),
				'singularity.chat-chat'
			);
		});
