...
suite('ChatDragAndDrop - resolveChatReferenceDropEntry', () => {
	...
	const backendResource = 'singularitycli-chat://backend/chat-1';
	const droppedClientResource = 'agent-host-singularitycli:/session-a';
	const ownClientResource = 'agent-host-singularitycli:/session-b';
	...
	test('a cross-agent-host reference yields no entry', () => {
		assert.strictEqual(
			resolveChatReferenceDropEntry(data, 'remote-host1-singularitycli://host1/session-b'),
			undefined
		);
	});
...
suite('ChatDragAndDrop - isSelfChatReferenceDrop', () => {
	...
	const sessionA = 'agent-host-singularitycli:/session-a';
	const sessionAPeer = 'agent-host-singularitycli:/session-a#peer-1';
	const sessionB = 'agent-host-singularitycli:/session-b';
...
suite('ChatDragAndDrop - isCrossAgentHostChatReferenceDrop', () => {
	...
	const localSessionA = 'agent-host-singularitycli:/session-a';
	const localSessionAPeer = 'agent-host-singularitycli:/session-a#peer-1';
	const localSessionB = 'agent-host-singularitycli:/session-b';
	const remoteSessionA = 'remote-host1-singularitycli://host1/session-a';
	const remoteSessionB = 'remote-host1-singularitycli://host1/session-b';
	const remoteOtherHost = 'remote-host2-singularitycli://host2/session-a';
