...
// --- "Show Chat Debug View" (contributed by extensions/singularity-chat/package.json    ---
// --- under view/title with when: view == workbench.panel.chat.view.singularity)    ---
...
MenuRegistry.appendMenuItem(MenuId.ViewTitle, {
	...
	when: ContextKeyExpr.equals('view', 'workbench.panel.chat.view.singularity'),
	group: '3_show',
	order: 2,
});
