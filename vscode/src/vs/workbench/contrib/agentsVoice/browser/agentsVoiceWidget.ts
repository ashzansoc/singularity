...
export interface VoiceWidgetOptions {
	...
	/** Show the singularity icon at the start of the header. */
	...
	private _updateDOMClassicLayout(reader: IReader): void {
		...
		if (onboarding) {
			...
			this._headerComponent.update({
				singularityIconSrc: this.callbacks.singularityIconSrc,
				showSingularityIcon: opts.showSingularityIcon,
