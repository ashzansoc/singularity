...
import { getSingularityRootPaths } from '../../../../platform/agentHost/common/singularityHome.js';
...
export class BrowserViewWorkbenchService extends Disposable implements IBrowserViewWorkbenchService {
	...
	private _getTrustedFileRoots(): string[] {
		// Trust Singularity roots so agents can create HTML files and open them in the browser.
		const roots = new Set(getSingularityRootPaths(this.environmentService.userHome.fsPath, process.env));
