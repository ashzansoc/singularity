...
import { IAutostartResult, IMcpAutostartOptions, IMcpServer, IMcpService, LazyCollectionState } from '../../common/mcpTypes.js';
...
export class TestMcpService implements IMcpService {
	...
	autostart(_token?: import('../../../../../base/common/cancellation.js').CancellationToken, _options?: IMcpAutostartOptions) {
