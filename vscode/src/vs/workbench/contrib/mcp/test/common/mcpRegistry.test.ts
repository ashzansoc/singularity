...
import { SINGULARITY_STRICT_PLUGIN_ONLY_CUSTOMIZATION_CONFIG } from '../../../../../platform/policy/common/singularityManagedSettings.js';
...
suite('Workbench - MCP - Registry', () => {
	...
	test('strict plugin-only customization hides non-plugin MCP collections and blocks direct lookup', () => {
		...
		configurationService.setUserConfiguration(SINGULARITY_STRICT_PLUGIN_ONLY_CUSTOMIZATION_CONFIG, true);
		configurationService.onDidChangeConfigurationEmitter.fire({
			affectsConfiguration: (key: string) => key === SINGULARITY_STRICT_PLUGIN_ONLY_CUSTOMIZATION_CONFIG,
