...
export interface IMcpAutostartOptions {
	/** When set, only MCP servers whose name appears in this message are autostarted. */
...
export interface IMcpService {
	...
	autostart(token?: CancellationToken, options?: IMcpAutostartOptions): IObservable<IAutostartResult>;
