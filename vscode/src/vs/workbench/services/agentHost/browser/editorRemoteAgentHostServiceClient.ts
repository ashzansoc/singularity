...
export class EditorRemoteAgentHostServiceClient extends Disposable implements IAgentHostService {
	...
	async executeExecutionTask(): Promise<import('../../../../platform/agentHost/common/agentService.js').IAgentHostExecutionTaskResult> {
		throw REMOTE_NOT_SUPPORTED('executeExecutionTask');
	}
