...
export class ViewsService extends Disposable implements IViewsService {
	...
	private registerOpenViewAction(viewDescriptor: IViewDescriptor): IDisposable {
		...
		// Stale view-layout customizations can hand the same view to two container
		// models during startup; registering the action twice would throw and abort
		// workbench initialization, so skip the duplicate instead.
