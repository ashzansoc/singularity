...
import { normalizeManagedSettings } from '../../../../platform/policy/common/singularityManagedSettings.js';
...
/**
 * Response shape from the Singularity `/singularity_internal/managed_settings` endpoint.
 * The endpoint returns `.github/singularity/settings.json` content from the
