...
import { INativeManagedSettingsService, IFileManagedSettingsService, collectManagedSettingsDefinitions, hasManagedSettingsDefinitions, projectManagedSettings, pickManagedSettings } from '../../../../platform/policy/common/singularityManagedSettings.js';
...
export class AccountPolicyService extends AbstractPolicyService implements IPolicyService, IAccountPolicyGateService {
	...
	protected async _updatePolicyDefinitions(policyDefinitions: IStringDictionary<PolicyDefinition>): Promise<void> {
		...
		const managedSettings = await this.updateSingularityManagedSettingDefinitions(policyDefinitions);
	...
	private async updateSingularityManagedSettingDefinitions(policyDefinitions: IStringDictionary<PolicyDefinition>): Promise<ManagedSettingsData | undefined> {
