...
// Singularity mandatory OTA updates
import './contrib/singularityUpdate/browser/singularityMandatoryUpdate.contribution.js';
import './contrib/singularityUpdate/browser/singularityBetaQuota.contribution.js';
