...
export class ChatResponseAgentTeamPart {
	...
	constructor(payload: {
		...
		mission: string;
		expanded: boolean;
		summary: ChatResponseAgentTeamPart['summary'];
		agents: ChatResponseAgentTeamPart['agents'];
		verificationPhase?: boolean;
	}) {
		this.id = payload.id;
		...
		this.verificationPhase = payload.verificationPhase;
	}
}
...
export class ChatDebugModelTurnEvent {
	...
	totalTokens?: number;
	cost?: number;
	singularityUsageNanoAiu?: number;
	durationInMillis?: number;
