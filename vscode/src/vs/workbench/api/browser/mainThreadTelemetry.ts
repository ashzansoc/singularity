...
/**
 * The core telemetry property under which the Singularity CAPI flight assignment
...
/**
 * The private command Singularity invokes to forward its CAPI flight assignments
