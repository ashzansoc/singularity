...
import './services/singularityBilling/browser/singularityBillingService.js';
import './contrib/singularityProfile/browser/singularityProfile.contribution.js';
...
import './contrib/connectors/browser/connectors.contribution.js';
...
// Singularity workspace shells (Plan / Repository / Testing / Docs / Architect)
import './contrib/singularityWorkspaces/browser/singularityWorkspaces.contribution.js';

// Singularity Brain (persistent user-level memory graph nav entry)
import './contrib/singularityBrain/browser/singularityBrain.contribution.js';
...
import './contrib/welcomeGettingStarted/browser/singularityAccessOverlay.js';
