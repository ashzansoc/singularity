...
declare module 'vscode' {
	...
	export interface ChatAgentTeamSummaryPayload {
		total: number;
		completed: number;
		working: number;
		queued: number;
	...
	export interface ChatAgentTeamAgentRowPayload {
		agentId: string;
		taskId: string;
		role: string;
		title: string;
	...
	export class ChatResponseAgentTeamPart {
		id: string;
		workflowId: string;
		mission: string;
		expanded: boolean;
		summary: ChatAgentTeamSummaryPayload;
		agents: ChatAgentTeamAgentRowPayload[];
	...
	export interface ChatResponseStream {
		...
		*/
		...
		/**
		 * Push or update the in-chat multi-agent mission panel (stable `id` replaces in place).
		 */
		agentTeam(payload: {
			id: string;
			workflowId: string;
	...
	export interface ChatResultUsage {
		...
		/**
		 * The number of singularity credits consumed by this request.
		 */
		readonly singularityCredits?: number;
