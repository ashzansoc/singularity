...
import * as pluginSingularityLocal from './extensions/singularity-chat/.eslintplugin/index.ts';
...
export default defineConfig(
			...
			'local/code-import-patterns': [
				...
				},
				{
					...
					'restrictions': [
						...
						'@vscode/copilot-api', // used by agentHost for Singularity API requests
	...
	},
	{
		...
		// to Singularity. Only the Singularity chat sessions provider may consume them; the
		...
		ignores: [
			'src/vs/sessions/contrib/providers/singularityChatSessions/**/*.ts'
		],
		languageOptions: {
			parser: tseslint.parser,
		},
				...
				'warn',
				{
					'patterns': [
						...
						},
						{
							...
							'message': 'IAgentSessionsService is provider-internal to Singularity. Only contrib/providers/singularityChatSessions may import it; the rest of the Agents window must stay provider-agnostic. See src/vs/sessions/SESSIONS.md.'
						}
					]
				}
			]
	...
	// singularity extension - main sources
	{
		files: [
			'extensions/singularity-chat/src/**/*.{ts,tsx}',
			'extensions/singularity-chat/test/**/*.{ts,tsx}',
		],
		ignores: [
			'extensions/singularity-chat/**/.esbuild.ts',
			'extensions/singularity-chat/src/extension/completions-core/vscode-node/bridge/src/completionsTelemetryServiceBridge.ts',
		],
		languageOptions: {
			parser: tseslint.parser,
		},
		plugins: {
			'import': pluginImport,
			'singularity-local': pluginSingularityLocal,
		},
		rules: {
			'local/code-no-dangerous-type-assertions': 'off',
			...
			'import/no-restricted-paths': [
				'warn',
				{
					zones: [
						...
						{
							target: './extensions/singularity-chat/src/',
							from: './extensions/singularity-chat/test/'
						},
						{
							target: './extensions/singularity-chat/src/shared-fetch-utils',
							from: ['./extensions/singularity-chat/src/extension', './extensions/singularity-chat/src/platform', './extensions/singularity-chat/src/util', './extensions/singularity-chat/src/lib']
						},
						{
							target: './extensions/singularity-chat/src/util',
							from: ['./extensions/singularity-chat/src/platform', './extensions/singularity-chat/src/extension']
						},
						{
							target: './extensions/singularity-chat/src/platform',
							from: ['./extensions/singularity-chat/src/extension']
						},
						{
							target: ['./extensions/singularity-chat/test', '!./extensions/singularity-chat/test/base/extHostContext/*.ts'],
							from: ['**/vscode-node/**', '**/vscode-worker/**']
						},
						{
							target: 'extensions/singularity-chat/src/!(lib)/**',
							from: './extensions/singularity-chat/src/lib'
						}
					]
				}
			],
			'singularity-local/no-instanceof-uri': ['warn'],
			'singularity-local/no-test-imports': ['warn'],
			'singularity-local/no-runtime-import': [
				'warn',
				{
					test: ['vscode'],
					'src/**/common/**/*': ['vscode'],
			...
			'singularity-local/no-funny-filename': ['warn'],
			'singularity-local/no-bad-gdpr-comment': ['warn'],
			'singularity-local/no-gdpr-event-name-mismatch': ['warn'],
			'singularity-local/no-unlayered-files': ['warn'],
			'singularity-local/no-restricted-singularity-pr-string': [
				'warn',
				{
					className: 'GitHubPullRequestProviders',
					string: 'Generate with Singularity'
				}
			],
			'singularity-local/no-nls-localize': ['warn'],
		}
	},
	// singularity extension - allow node imports in node layer
	{
		files: [
			'extensions/singularity-chat/**/{vscode-node,node}/**/*.ts',
			'extensions/singularity-chat/**/{vscode-node,node}/**/*.tsx',
		],
		rules: {
			'no-restricted-imports': 'off'
		}
	},
	// singularity extension - override files (tests, build, etc.)
	{
		files: [
			'extensions/singularity-chat/test/**',
			'extensions/singularity-chat/src/vscodeTypes.ts',
			'extensions/singularity-chat/script/**',
			'extensions/singularity-chat/src/extension/*.d.ts',
			'extensions/singularity-chat/build/**',
		],
		rules: {
			'singularity-local/no-unlayered-files': 'off',
			'no-restricted-imports': 'off'
		}
	},
	// singularity extension - TSX linebreak rule
	{
		files: [
			'extensions/singularity-chat/src/extension/**/*.tsx',
		],
		plugins: {
			'singularity-local': pluginSingularityLocal,
		},
		rules: {
			'singularity-local/no-missing-linebreak': 'warn'
		}
	},
	// singularity extension - test-only rule
	{
		files: [
			'extensions/singularity-chat/**/*.test.ts',
			'extensions/singularity-chat/**/*.test.tsx',
		],
		plugins: {
			'singularity-local': pluginSingularityLocal,
		},
		rules: {
			'singularity-local/no-test-only': 'warn'
		}
	},
	// singularity extension - no-explicit-any
	{
		files: [
			'extensions/singularity-chat/src/**/*.ts',
		],
		ignores: [
			'extensions/singularity-chat/src/util/vs/**/*.ts',
			'extensions/singularity-chat/src/**/*.spec.ts',
			'extensions/singularity-chat/src/extension/agents/singularitycli/node/nodePtyShim.ts',
			'extensions/singularity-chat/src/extension/byok/common/anthropicMessageConverter.ts',
			'extensions/singularity-chat/src/extension/byok/common/geminiFunctionDeclarationConverter.ts',
			'extensions/singularity-chat/src/extension/byok/common/geminiMessageConverter.ts',
			'extensions/singularity-chat/src/extension/byok/vscode-node/anthropicProvider.ts',
			'extensions/singularity-chat/src/extension/byok/vscode-node/geminiNativeProvider.ts',
			'extensions/singularity-chat/src/extension/byok/vscode-node/ollamaProvider.ts',
			'extensions/singularity-chat/src/extension/chatSessions/vscode-node/singularityCloudSessionContentBuilder.ts',
			'extensions/singularity-chat/src/extension/chatSessions/vscode-node/singularityCloudSessionsProvider.ts',
			'extensions/singularity-chat/src/extension/codeBlocks/node/codeBlockProcessor.ts',
			'extensions/singularity-chat/src/extension/codeBlocks/vscode-node/provider.ts',
			'extensions/singularity-chat/src/extension/configuration/vscode-node/configurationMigration.ts',
			'extensions/singularity-chat/src/extension/context/node/resolvers/genericInlineIntentInvocation.ts',
			'extensions/singularity-chat/src/extension/context/node/resolvers/genericPanelIntentInvocation.ts',
			'extensions/singularity-chat/src/extension/context/node/resolvers/inlineFixIntentInvocation.ts',
			'extensions/singularity-chat/src/extension/context/node/resolvers/promptWorkspaceLabels.ts',
			'extensions/singularity-chat/src/extension/contextKeys/vscode-node/contextKeys.contribution.ts',
			'extensions/singularity-chat/src/extension/conversation/vscode-node/userActions.ts',
			'extensions/singularity-chat/src/extension/extension/vscode/services.ts',
			'extensions/singularity-chat/src/extension/inlineChat/node/rendererVisualization.ts',
			'extensions/singularity-chat/src/extension/inlineChat/vscode-node/inlineChatCommands.ts',
			'extensions/singularity-chat/src/extension/inlineEdits/common/observableWorkspaceRecordingReplayer.ts',
			'extensions/singularity-chat/src/extension/inlineEdits/vscode-node/parts/vscodeWorkspace.ts',
			'extensions/singularity-chat/src/extension/intents/node/editCodeIntent.ts',
			'extensions/singularity-chat/src/extension/intents/node/editCodeStep.ts',
			'extensions/singularity-chat/src/extension/intents/node/fixIntent.ts',
			'extensions/singularity-chat/src/extension/intents/node/newIntent.ts',
			'extensions/singularity-chat/src/extension/intents/node/searchIntent.ts',
			'extensions/singularity-chat/src/extension/languageContextProvider/vscode-node/languageContextProviderService.ts',
			'extensions/singularity-chat/src/extension/linkify/common/commands.ts',
			'extensions/singularity-chat/src/extension/linkify/common/responseStreamWithLinkification.ts',
			'extensions/singularity-chat/src/extension/linkify/test/node/util.ts',
			'extensions/singularity-chat/src/extension/log/vscode-node/loggingActions.ts',
			'extensions/singularity-chat/src/extension/log/vscode-node/requestLogTree.ts',
			'extensions/singularity-chat/src/extension/mcp/test/vscode-node/util.ts',
			'extensions/singularity-chat/src/extension/mcp/vscode-node/commands.ts',
			'extensions/singularity-chat/src/extension/mcp/vscode-node/nuget.ts',
			'extensions/singularity-chat/src/extension/onboardDebug/node/singularityDebugWorker/rpc.ts',
			'extensions/singularity-chat/src/extension/onboardDebug/node/parseLaunchConfigFromResponse.ts',
			'extensions/singularity-chat/src/extension/onboardDebug/vscode-node/singularityDebugCommandHandle.ts',
			'extensions/singularity-chat/src/extension/prompt/common/toolCallRound.ts',
			'extensions/singularity-chat/src/extension/prompt/node/chatMLFetcher.ts',
			'extensions/singularity-chat/src/extension/prompt/node/chatParticipantTelemetry.ts',
			'extensions/singularity-chat/src/extension/prompt/node/editGeneration.ts',
			'extensions/singularity-chat/src/extension/prompt/node/intents.ts',
			'extensions/singularity-chat/src/extension/prompt/node/todoListContextProvider.ts',
			'extensions/singularity-chat/src/extension/prompt/vscode-node/endpointProviderImpl.ts',
			'extensions/singularity-chat/src/extension/prompt/vscode-node/requestLoggerImpl.ts',
			'extensions/singularity-chat/src/extension/prompts/node/agent/promptRegistry.ts',
			'extensions/singularity-chat/src/extension/prompts/node/base/promptElement.ts',
			'extensions/singularity-chat/src/extension/prompts/node/base/promptRenderer.ts',
			'extensions/singularity-chat/src/extension/prompts/node/test/utils.ts',
			'extensions/singularity-chat/src/extension/replay/common/chatReplayResponses.ts',
			'extensions/singularity-chat/src/extension/replay/node/replayParser.ts',
			'extensions/singularity-chat/src/extension/replay/vscode-node/replayDebugSession.ts',
			'extensions/singularity-chat/src/extension/review/node/githubReviewAgent.ts',
			'extensions/singularity-chat/src/extension/test/node/services.ts',
			'extensions/singularity-chat/src/extension/test/vscode-node/extension.test.ts',
			'extensions/singularity-chat/src/extension/test/vscode-node/sanity.sanity-test.ts',
			'extensions/singularity-chat/src/extension/test/vscode-node/session.test.ts',
			'extensions/singularity-chat/src/extension/tools/common/toolSchemaNormalizer.ts',
			'extensions/singularity-chat/src/extension/tools/common/toolsService.ts',
			'extensions/singularity-chat/src/extension/typescriptContext/common/serverProtocol.ts',
			'extensions/singularity-chat/src/extension/typescriptContext/serverPlugin/src/common/baseContextProviders.ts',
			'extensions/singularity-chat/src/extension/typescriptContext/serverPlugin/src/common/contextProvider.ts',
			'extensions/singularity-chat/src/extension/typescriptContext/serverPlugin/src/common/protocol.ts',
			'extensions/singularity-chat/src/extension/typescriptContext/serverPlugin/src/common/typescripts.ts',
			'extensions/singularity-chat/src/extension/typescriptContext/serverPlugin/src/common/utils.ts',
			'extensions/singularity-chat/src/extension/typescriptContext/vscode-node/inspector.ts',
			'extensions/singularity-chat/src/extension/typescriptContext/vscode-node/languageContextService.ts',
			'extensions/singularity-chat/src/extension/workspaceRecorder/vscode-node/workspaceListenerService.ts',
			'extensions/singularity-chat/src/extension/workspaceSemanticSearch/node/semanticSearchTextSearchProvider.ts',
			'extensions/singularity-chat/src/lib/node/chatLibMain.ts',
			'extensions/singularity-chat/src/platform/authentication/test/node/simulationTestSingularityTokenManager.ts',
			'extensions/singularity-chat/src/platform/chat/common/blockedExtensionService.ts',
			'extensions/singularity-chat/src/platform/chunking/common/chunkingEndpointClientImpl.ts',
			'extensions/singularity-chat/src/platform/commands/common/mockRunCommandExecutionService.ts',
			'extensions/singularity-chat/src/platform/commands/common/runCommandExecutionService.ts',
			'extensions/singularity-chat/src/platform/commands/vscode/runCommandExecutionServiceImpl.ts',
			'extensions/singularity-chat/src/platform/configuration/common/configurationService.ts',
			'extensions/singularity-chat/src/platform/configuration/common/validator.ts',
			'extensions/singularity-chat/src/platform/configuration/test/common/inMemoryConfigurationService.ts',
			'extensions/singularity-chat/src/platform/configuration/vscode/configurationServiceImpl.ts',
			'extensions/singularity-chat/src/platform/customInstructions/common/customInstructionsService.ts',
			'extensions/singularity-chat/src/platform/debug/vscode/debugOutputListener.ts',
			'extensions/singularity-chat/src/platform/diff/node/diffWorkerMain.ts',
			'extensions/singularity-chat/src/platform/editing/common/notebookDocumentSnapshot.ts',
			'extensions/singularity-chat/src/platform/editing/common/textDocumentSnapshot.ts',
			'extensions/singularity-chat/src/platform/embeddings/common/embeddingsGrouper.ts',
			'extensions/singularity-chat/src/platform/embeddings/common/embeddingsIndex.ts',
			'extensions/singularity-chat/src/platform/embeddings/common/remoteEmbeddingsComputer.ts',
			'extensions/singularity-chat/src/platform/endpoint/node/modelMetadataFetcher.ts',
			'extensions/singularity-chat/src/platform/endpoint/test/node/openaiCompatibleEndpoint.ts',
			'extensions/singularity-chat/src/platform/env/common/packagejson.ts',
			'extensions/singularity-chat/src/platform/extensions/common/extensionsService.ts',
			'extensions/singularity-chat/src/platform/filesystem/common/fileSystemService.ts',
			'extensions/singularity-chat/src/platform/github/common/githubService.ts',
			'extensions/singularity-chat/src/platform/github/common/nullOctokitServiceImpl.ts',
			'extensions/singularity-chat/src/platform/inlineEdits/common/dataTypes/edit.ts',
			'extensions/singularity-chat/src/platform/inlineEdits/common/dataTypes/textEditLengthHelper/length.ts',
			'extensions/singularity-chat/src/platform/inlineEdits/common/editReason.ts',
			'extensions/singularity-chat/src/platform/inlineEdits/common/statelessNextEditProvider.ts',
			'extensions/singularity-chat/src/platform/inlineEdits/common/utils/observable.ts',
			'extensions/singularity-chat/src/platform/languages/common/languageDiagnosticsService.ts',
			'extensions/singularity-chat/src/platform/log/common/logExecTime.ts',
			'extensions/singularity-chat/src/platform/log/common/logService.ts',
			'extensions/singularity-chat/src/platform/log/vscode/outputChannelLogTarget.ts',
			'extensions/singularity-chat/src/platform/nesFetch/common/completionsFetchService.ts',
			'extensions/singularity-chat/src/platform/nesFetch/node/completionsFetchServiceImpl.ts',
			'extensions/singularity-chat/src/platform/networking/common/fetch.ts',
			'extensions/singularity-chat/src/platform/networking/common/fetcherService.ts',
			'extensions/singularity-chat/src/platform/networking/common/networking.ts',
			'extensions/singularity-chat/src/platform/networking/common/openai.ts',
			'extensions/singularity-chat/src/platform/networking/node/baseFetchFetcher.ts',
			'extensions/singularity-chat/src/platform/networking/node/chatStream.ts',
			'extensions/singularity-chat/src/platform/networking/node/fetcherFallback.ts',
			'extensions/singularity-chat/src/platform/networking/node/nodeFetchFetcher.ts',
			'extensions/singularity-chat/src/platform/networking/node/nodeFetcher.ts',
			'extensions/singularity-chat/src/platform/networking/node/stream.ts',
			'extensions/singularity-chat/src/platform/networking/node/test/nodeFetcherService.ts',
			'extensions/singularity-chat/src/platform/networking/vscode-node/electronFetcher.ts',
			'extensions/singularity-chat/src/platform/networking/vscode-node/fetcherServiceImpl.ts',
			'extensions/singularity-chat/src/platform/notification/common/notificationService.ts',
			'extensions/singularity-chat/src/platform/notification/vscode/notificationServiceImpl.ts',
			'extensions/singularity-chat/src/platform/openai/node/fetch.ts',
			'extensions/singularity-chat/src/platform/parser/node/nodes.ts',
			'extensions/singularity-chat/src/platform/parser/node/parserServiceImpl.ts',
			'extensions/singularity-chat/src/platform/parser/node/parserWorker.ts',
			'extensions/singularity-chat/src/platform/parser/node/treeSitterQueries.ts',
			'extensions/singularity-chat/src/platform/remoteCodeSearch/common/githubCodeSearchService.ts',
			'extensions/singularity-chat/src/platform/remoteSearch/node/codeOrDocsSearchClientImpl.ts',
			'extensions/singularity-chat/src/platform/review/vscode/reviewServiceImpl.ts',
			'extensions/singularity-chat/src/platform/scopeSelection/vscode-node/scopeSelectionImpl.ts',
			'extensions/singularity-chat/src/platform/snippy/common/snippyTypes.ts',
			'extensions/singularity-chat/src/platform/survey/vscode/surveyServiceImpl.ts',
			'extensions/singularity-chat/src/platform/tasks/vscode/tasksService.ts',
			'extensions/singularity-chat/src/platform/telemetry/common/failingTelemetryReporter.ts',
			'extensions/singularity-chat/src/platform/telemetry/common/telemetryData.ts',
			'extensions/singularity-chat/src/platform/telemetry/node/azureInsightsReporter.ts',
			'extensions/singularity-chat/src/platform/telemetry/node/spyingTelemetryService.ts',
			'extensions/singularity-chat/src/platform/terminal/common/terminalService.ts',
			'extensions/singularity-chat/src/platform/terminal/vscode/terminalServiceImpl.ts',
			'extensions/singularity-chat/src/platform/test/common/endpointTestFixtures.ts',
			'extensions/singularity-chat/src/platform/test/common/testExtensionsService.ts',
			'extensions/singularity-chat/src/platform/test/node/extensionContext.ts',
			'extensions/singularity-chat/src/platform/test/node/fetcher.ts',
			'extensions/singularity-chat/src/platform/test/node/services.ts',
			'extensions/singularity-chat/src/platform/test/node/simulationWorkspace.ts',
			'extensions/singularity-chat/src/platform/test/node/telemetry.ts',
			'extensions/singularity-chat/src/platform/test/node/testWorkbenchService.ts',
			'extensions/singularity-chat/src/platform/testing/common/nullWorkspaceMutationManager.ts',
			'extensions/singularity-chat/src/platform/thinking/common/thinking.ts',
			'extensions/singularity-chat/src/platform/tokenizer/node/tikTokenizerWorker.ts',
			'extensions/singularity-chat/src/platform/tokenizer/node/tokenizer.ts',
			'extensions/singularity-chat/src/platform/workbench/common/workbenchService.ts',
			'extensions/singularity-chat/src/platform/workbench/vscode/workbenchServiceImpt.ts',
			'extensions/singularity-chat/src/platform/workspaceChunkSearch/node/nullWorkspaceFileIndex.ts',
			'extensions/singularity-chat/src/platform/workspaceChunkSearch/node/tfidfChunkSearch.ts',
			'extensions/singularity-chat/src/platform/workspaceChunkSearch/node/workspaceFileIndex.ts',
			'extensions/singularity-chat/src/platform/workspaceRecorder/common/resolvedRecording/resolvedRecording.ts',
			'extensions/singularity-chat/src/util/common/async.ts',
			'extensions/singularity-chat/src/util/common/cache.ts',
			'extensions/singularity-chat/src/util/common/chatResponseStreamImpl.ts',
			'extensions/singularity-chat/src/util/common/debounce.ts',
			'extensions/singularity-chat/src/util/common/debugValueEditorGlobals.ts',
			'extensions/singularity-chat/src/util/common/diff.ts',
			'extensions/singularity-chat/src/util/common/progress.ts',
			'extensions/singularity-chat/src/util/common/test/shims/chatTypes.ts',
			'extensions/singularity-chat/src/util/common/test/shims/editing.ts',
			'extensions/singularity-chat/src/util/common/test/shims/l10n.ts',
			'extensions/singularity-chat/src/util/common/test/shims/notebookDocument.ts',
			'extensions/singularity-chat/src/util/common/test/shims/vscodeTypesShim.ts',
			'extensions/singularity-chat/src/util/common/test/simpleMock.ts',
			'extensions/singularity-chat/src/util/common/timeTravelScheduler.ts',
			'extensions/singularity-chat/src/util/common/types.ts',
			'extensions/singularity-chat/src/util/node/worker.ts',
		],
		languageOptions: {
			parser: tseslint.parser,
		},
	...
	// singularity extension - chatLibMain exception
	{
		files: [
			'extensions/singularity-chat/src/lib/node/chatLibMain.ts',
		],
