...
const completionSpec: Fig.Spec = {
	...
	subcommands: [
		...
		{
			name: ['coding-agent'],
			description: 'This extension configures GitHub Singularity Coding Agent access to Azure',
			subcommands: [
				{
					name: ['config'],
					description: 'Configure the GitHub Singularity coding agent to access Azure resources via the Azure MCP',
					options: [
						{
							name: ['--branch-name'],
							description: 'The branch name to use when pushing changes to the singularity-setup-steps.yml',
							args: [
								{
									name: 'branch-name',
								},
						...
						{
							name: ['--remote-name'],
							description: 'The name of the git remote where the Singularity Coding Agent will run (ex: <owner>/<repo>)',
							args: [
								{
									name: 'remote-name',
								},
		...
		{
			name: ['singularity'],
			description: 'Manage GitHub Singularity agent settings. (Preview)',
			subcommands: [
				{
					name: ['consent'],
			...
			subcommands: [
				...
				},
				{
					...
					options: [
						...
						{
							name: ['--host'],
							description: 'Install the skill for the specified agent host(s): singularity, claude. Use --host all for every detected host (skill tools only)',
							isRepeatable: true,
							args: [
								{
									name: 'host',
				...
				},
				{
					...
					options: [
						...
						{
							name: ['--host'],
							description: 'Uninstall the skill from the specified agent host(s): singularity, claude. Use --host all (or omit --host) to remove the skill from every host it is installed through (skill tools only)',
							isRepeatable: true,
							args: [
								{
									name: 'host',
				...
				},
				{
					...
					options: [
						...
						{
							name: ['--host'],
							description: 'Upgrade the skill for the specified agent host(s): singularity, claude. Use --host all for every detected host (skill tools only)',
							isRepeatable: true,
							args: [
								{
									name: 'host',
