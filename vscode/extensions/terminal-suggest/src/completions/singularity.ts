...
const singularitySpec: Fig.Spec = {
	name: 'singularity',
	description: 'GitHub Singularity CLI - An AI-powered coding assistant',
	options: [
		{
			name: '--add-dir',
		...
		{
			name: '--log-dir',
			description: 'Set log file directory (default: ~/.singularity/logs/)',
			args: {
				name: 'directory',
				template: 'folders'
			}
...
export default singularitySpec;
