# [Prompts (.prompt.md)](https://code.visualstudio.com/docs/singularity/customization/prompt-files)
...
model: "GPT-5 (singularity)"     # Optional: selected model, or fallback array
...
```yaml
model: ['GPT-5 (singularity)', 'Claude Sonnet 4.5 (singularity)']
```
