# [Custom Agents (.agent.md)](https://code.visualstudio.com/docs/singularity/customization/custom-agents)
...
```yaml
model: ['Claude Sonnet 4.5 (singularity)', 'GPT-5 (singularity)']  # First available model is used
```
