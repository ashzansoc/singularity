# [agent instructions](https://code.visualstudio.com/docs/singularity/customization/custom-instructions)
...
|------|----------|---------|
| `singularity-instructions.md` | `.github/` | Project-wide standards (recommended, cross-editor) |
...
- **Using both file types**: Having both `singularity-instructions.md` and `AGENTS.md`
