...
|------|------|----------|-----------|
| agent instructions | `singularity-instructions.md`, `AGENTS.md` | `.github/` or root | [Link](./references/agent-instructions.md) |
