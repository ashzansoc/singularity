...
Use direct debug log files written by Singularity Chat:
...
```jsonl
{"ts":1773200251309,"dur":0,"sid":"62f52dec","type":"discovery","name":"Load Instructions","spanId":"2cb1f2f4","status":"ok","attrs":{"details":"Resolved 0 instructions in 0.0ms | folders: [/c:/Users/user/.singularity/instructions, /workspace/.github/instructions]","category":"discovery","source":"core"}}
...
```jsonl
{"ts":1773200251300,"dur":0,"sid":"62f52dec","type":"session_start","name":"session_start","spanId":"session-start-62f52dec","status":"ok","attrs":{"singularityVersion":"0.43.2026033104","vscodeVersion":"1.99.0"}}
```
Key attrs: `singularityVersion`, `vscodeVersion`. Useful for identifying which build produced the logs.
...
- Custom instructions: `https://code.visualstudio.com/docs/singularity/customization/custom-instructions`
- Prompt files: `https://code.visualstudio.com/docs/singularity/customization/prompt-files`
- Custom agents: `https://code.visualstudio.com/docs/singularity/customization/custom-agents`
- Language models: `https://code.visualstudio.com/docs/singularity/customization/language-models`
- MCP servers: `https://code.visualstudio.com/docs/singularity/customization/mcp-servers`
- Hooks: `https://code.visualstudio.com/docs/singularity/customization/hooks`
- Agent plugins: `https://code.visualstudio.com/docs/singularity/customization/agent-plugins`
...
## Last Resort — Singularity Issues Wiki

When your investigation yields no clear root cause or you have no specific remediation suggestions:

1. Load the Singularity Issues wiki page: `https://github.com/microsoft/vscode/wiki/Singularity-Issues`.
...
- If you suspect network issues, run `singularity.chat.debug.collectDiagnostics` via the `run_vscode_command` tool and use the returned diagnostics string before concluding.
- If no clear cause is found, consult the Singularity Issues wiki before giving up. If even the wiki has no relevant information, say so explicitly.
