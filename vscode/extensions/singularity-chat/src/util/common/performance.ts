 ...
 *
 * **Singularity Token Wait** — authentication readiness blocking activation:
 * `code/chat/ext/willWaitForSingularityToken` → `code/chat/ext/didWaitForSingularityToken`
 */
...
export const ChatExtGlobalPerfMark = {
	...
	/** Waiting for Singularity token starts */
	WillWaitForSingularityToken: 'willWaitForSingularityToken',
	/** Singularity token received */
	DidWaitForSingularityToken: 'didWaitForSingularityToken',
} as const;
