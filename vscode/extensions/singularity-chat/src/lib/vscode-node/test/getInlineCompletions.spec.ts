...
function createTestSingularityToken(): SingularityToken {
	return new SingularityToken(createTestExtendedTokenInfo({
...
class TestAuthService extends Disposable implements IAuthenticationService {
	...
	readonly hasSingularityTokenSource = true;
	readonly singularityToken = createTestSingularityToken();
...
describe('getInlineCompletions', () => {
	const completionsPath = '/v1/engines/gpt-41-singularity/completions';
