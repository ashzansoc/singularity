...
export abstract class AbstractEnvService implements IEnvService {
	...
	/**
	 * The name and version of the Singularity chat plugin.
	 * or `{ name: 'singularity-chat', version: '1.7.21' }`.
	 */
 ...
 * that identify the host editor and the Singularity plugin to the backend.
 *
