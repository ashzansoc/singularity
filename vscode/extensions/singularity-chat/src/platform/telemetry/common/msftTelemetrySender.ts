...
export class BaseMsftTelemetrySender implements IMSFTTelemetrySender {
	...
	constructor(
		singularityTokenStore: ISingularityTokenStore,
		...
		this.processToken(singularityTokenStore.singularityToken);
		this._disposables.add(singularityTokenStore.onDidStoreUpdate(() => this.processToken(singularityTokenStore.singularityToken)));
	}
	...
	private processToken(token: SingularityToken | undefined) {
