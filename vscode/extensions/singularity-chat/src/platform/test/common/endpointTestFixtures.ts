...
export const ReasoningPropertyVerifiers = {
	...
	/**
	 * Verifies that a message has Singularity-style reasoning properties
	 */
	hasSingularityReasoningProperties(message: any, expectedId: string, expectedText: string): boolean {
...
export const TestThinkingData = {
	...
	singularity: {
		id: 'singularity-reasoning-456',
		text: 'Singularity-style reasoning analysis'
	},
	azure: {
