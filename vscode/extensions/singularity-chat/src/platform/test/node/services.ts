...
import { ISingularityTokenManager } from '../../authentication/common/singularityTokenManager';
import { SingularityTokenStore, ISingularityTokenStore } from '../../authentication/common/singularityTokenStore';
import { StaticGitHubAuthenticationService } from '../../authentication/common/staticGitHubAuthenticationService';
import { createStaticGitHubTokenProvider } from '../../authentication/node/singularityTokenManager';
import { SimulationTestSingularityTokenManager } from '../../authentication/test/node/simulationTestSingularityTokenManager';
...
export function _createBaselineServices(): TestingServiceCollection {
	...
	testingServiceCollection.define(ISingularityTokenStore, new SyncDescriptor(SingularityTokenStore));
	...
	testingServiceCollection.define(ISingularityTokenManager, new SyncDescriptor(SimulationTestSingularityTokenManager));
