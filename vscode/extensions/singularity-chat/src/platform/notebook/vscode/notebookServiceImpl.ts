...
const NOTEBOOK_AGENT_USAGE_KEY = 'singularity.chat.notebookAgentModeUsage';
...
export class NotebookService implements INotebookService {
	...
	constructor(
		...
		this._isVariableFilteringEnabled = this._experimentationService.getTreatmentVariable('singularitychat.notebookVariableFiltering')
