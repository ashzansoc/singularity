...
export namespace SessionType {
	...
	export const AgentHostSingularity = 'agent-host-singularity';
}
 ...
 * - `singularitycli://<sessionId>` — CLI in-process sessions
...
export function decodeSessionId(sessionResource: URI): string {
	if (sessionResource.scheme === SessionType.SingularityCLI || sessionResource.scheme === SessionType.ClaudeCode) {
