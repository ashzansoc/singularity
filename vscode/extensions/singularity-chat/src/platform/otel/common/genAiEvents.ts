...
export function emitSessionStartEvent(
	...
	otel.emitLogRecord('singularity_chat.session.start', {
...
export function emitToolCallEvent(
	...
	otel.emitLogRecord(`singularity_chat.tool.call: ${toolName}`, {
		'event.name': 'singularity_chat.tool.call',
...
export function emitAgentTurnEvent(
	...
	otel.emitLogRecord(`singularity_chat.agent.turn: ${turnIndex}`, {
		'event.name': 'singularity_chat.agent.turn',
...
export function emitEditFeedbackEvent(
	...
	otel.emitLogRecord(`singularity_chat.edit.feedback: ${outcome}`, {
		'event.name': 'singularity_chat.edit.feedback',
		'outcome': outcome,
...
export function emitEditHunkActionEvent(
	...
	otel.emitLogRecord(`singularity_chat.edit.hunk.action: ${outcome}`, {
		'event.name': 'singularity_chat.edit.hunk.action',
		'outcome': outcome,
		'language_id': languageId,
		'request_id': requestId,
...
export function emitInlineDoneEvent(
	...
	otel.emitLogRecord(`singularity_chat.inline.done: ${accepted ? 'accepted' : 'rejected'}`, {
		'event.name': 'singularity_chat.inline.done',
		'accepted': accepted,
		'language_id': languageId,
...
export function emitEditSurvivalEvent(
	...
	otel.emitLogRecord(`singularity_chat.edit.survival: ${editSource}`, {
		'event.name': 'singularity_chat.edit.survival',
...
export function emitUserFeedbackEvent(
	...
	otel.emitLogRecord(`singularity_chat.user.feedback: ${rating}`, {
		'event.name': 'singularity_chat.user.feedback',
		'rating': rating,
		'participant': participant,
...
export function emitCloudSessionInvokeEvent(
	...
	otel.emitLogRecord(`singularity_chat.cloud.session.invoke: ${partnerAgent}`, {
		'event.name': 'singularity_chat.cloud.session.invoke',
