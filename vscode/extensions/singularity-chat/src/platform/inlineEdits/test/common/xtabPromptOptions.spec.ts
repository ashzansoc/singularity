...
describe('applyStrategyConfig', () => {
	...
	it('forces includeTagsInCurrentFile=true for SingularityNesXtab', () => {
	...
	it('preserves undefined for option bags neither side specifies', () => {
		...
		// SingularityNesXtab only sets includeTagsInCurrentFile; nested option bags should stay undefined.
