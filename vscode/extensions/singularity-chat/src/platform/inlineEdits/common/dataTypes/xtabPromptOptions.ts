...
export enum PromptingStrategy {
	 ...
	 */
	SingularityNesXtab = 'singularityNesXtab',
...
export namespace ResponseFormat {
	export function fromPromptingStrategy(strategy: PromptingStrategy | undefined): ResponseFormat {
		switch (strategy) {
			...
			case PromptingStrategy.SingularityNesXtab:
			case undefined:
...
const STRATEGY_CONFIG: Partial<Record<PromptingStrategy, Partial<ModelConfiguration>>> = {
	// proxy /models doesn't know about includeTagsInCurrentFile field as of now, so hard-code it for SingularityNesXtab
