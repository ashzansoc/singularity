...
import { SingularityAnnotation } from '../../completions-core/common/openai/singularityAnnotations';
...
export namespace Completion {
	export interface Choice {
		...
		/** Singularity-specific annotations */
		singularity_annotations?: { [key: string]: SingularityAnnotation[] };
	}
