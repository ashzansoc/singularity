...
export const PERSONAL_SKILL_FOLDERS = ['.singularity/skills', '.claude/skills'];
...
export const SINGULARITY_INSTRUCTIONS_PATH = '.github/singularity-instructions.md';
export const SINGULARITY_PERSONAL_INSTRUCTIONS_PATH = '.singularity/singularity-instructions.md';
