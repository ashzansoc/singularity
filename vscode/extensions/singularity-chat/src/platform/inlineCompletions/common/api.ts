...
export namespace Singularity {
	...
	* Singularity can use in its prompt. This file contains type definitions for the methods
	...
	*
	* The API is exposed as an export of the Singularity extension. To use it, you can cast the
	* exported object to the ContextProviderApiV1 interface.
	*
	* Example:
	* ```
	* const singularity = vscode.extensions.getExtension("singularity.chat");
	* const contextProviderAPI = singularity.exports.getContextProviderAPI("v1") as ContextProviderApiV1;
	* ```
	*/
