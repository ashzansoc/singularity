...
describe('SingularityChatEndpoint - Reasoning Properties', () => {
	...
	describe('CAPI reasoning properties', () => {
		it('should set reasoning_opaque and reasoning_text properties when processing thinking content', () => {
			const endpoint = new SingularityChatEndpoint(
				modelMetadata,
			...
			const thinkingMessage = createThinkingMessage('singularity-thinking-abc', 'singularity reasoning process');
			...
			expect(messages[0].reasoning_opaque).toBe('singularity-thinking-abc');
			expect(messages[0].reasoning_text).toBe('singularity reasoning process');
		});
		...
		it('should handle multiple messages with thinking content', () => {
			...
			const thinkingMessage = createThinkingMessage('singularity-reasoning-def', 'analyzing the code request');
			...
			expect(messages[1].reasoning_opaque).toBe('singularity-reasoning-def');
