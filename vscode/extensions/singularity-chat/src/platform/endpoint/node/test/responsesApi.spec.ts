...
describe('phase commentary followed by phase final_answer', () => {
	it('inserts a separator between commentary and final_answer text in the stream', async () => {
		...
		const commentaryText = 'Responding directly in commentary as requested. My name is GitHub Singularity.';
		const finalText = 'My name is GitHub Singularity.';
...
describe('processResponseFromChatEndpoint terminal events', () => {
	...
	it('maps a raw error stream event to a terminal ServerError completion', async () => {
		...
		// surfaced as a `singularityErrors` progress delta and never yields a terminal
