...
class InitializedWorkspaceRecorderFeature extends Disposable {
	private readonly _logProvider = new VirtualTextDocumentProvider('singularityLogProvider');
	...
	constructor(
		...
		const commandIdOpenRecordingFolder = 'vscodeSingularity.openRecordingFolder';
		...
		const commandIdAddBookmark = 'vscodeSingularity.addRecordingBookmark';
		...
		const commandIdViewRecording = 'vscodeSingularity.viewRecording';
