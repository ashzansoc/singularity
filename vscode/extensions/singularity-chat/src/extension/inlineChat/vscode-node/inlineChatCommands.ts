...
export function registerInlineChatCommands(accessor: ServicesAccessor): IDisposable {
	...
	const doExplain = async (arg0: any, fromPalette?: true) => {
		...
		if (activeDocumentUri && selectedText && !await ignoreService.isSingularityIgnored(activeDocumentUri)) {
...
${message}`,
	...
	// register commands
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.explain', doExplain));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.explain.palette', () => doExplain(undefined, true)));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review', () => instaService.createInstance(ReviewSession).review('selection', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.stagedChanges', () => instaService.createInstance(ReviewSession).review('index', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.unstagedChanges', () => instaService.createInstance(ReviewSession).review('workingTree', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.changes', () => instaService.createInstance(ReviewSession).review('all', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.stagedFileChange', (resource: vscode.SourceControlResourceState) => {
	...
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.unstagedFileChange', (resource: vscode.SourceControlResourceState) => {
	...
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.codeReview.run', (input: CodeReviewInput) => {
		return instaService.invokeFunction(reviewFileChanges, input);
	}));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.apply', doApplyReview));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.applyAndNext', (commentThread: vscode.CommentThread) => doApplyReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.applyShort', (commentThread: vscode.CommentThread) => doApplyReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.continueInInlineChat', doContinueInInlineChat));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.continueInChat', doContinueInChat));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.discard', doDiscardReview));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.discardAndNext', (commentThread: vscode.CommentThread) => doDiscardReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.discardShort', (commentThread: vscode.CommentThread) => doDiscardReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.discardAll', doDiscardAllReview));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.markHelpful', markReviewHelpful));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.markUnhelpful', markReviewUnhelpful));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.previous', thread => goToNextReview(thread, -1)));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.next', thread => goToNextReview(thread, +1)));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.review.current', thread => goToNextReview(thread, 0)));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.generate', doGenerate));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.fix', doFix));
	disposables.add(vscode.commands.registerCommand('singularity.chat.chat.generateAltText', doGenerateAltText));
