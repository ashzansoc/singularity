...
export class ToolsContribution extends Disposable {
	constructor(
		...
		for (const [name, tool] of toolsService.singularityTools) {
		...
		this._register(vscode.commands.registerCommand('singularity.chat.debug.resetVirtualToolGroups', async () => {
		...
		this._register(vscode.commands.registerCommand('singularity.chat.chat.tools.memory.showMemories', async () => {
		...
		this._register(vscode.commands.registerCommand('singularity.chat.chat.tools.memory.resolveMemoryFileUri', (memoryPath: string, sessionResource?: string): string | undefined => {
		...
		this._register(vscode.commands.registerCommand('singularity.chat.chat.tools.memory.clearMemories', async () => {
