...
export class FindFilesTool implements ISingularityTool<IFindFilesToolParams> {
	...
	async resolveInput(input: IFindFilesToolParams, _promptContext: IBuildPromptContext, mode: SingularityToolMode): Promise<IFindFilesToolParams> {
		...
		return {
			...input,
			query,
			maxResults: mode === SingularityToolMode.FullContext ?
