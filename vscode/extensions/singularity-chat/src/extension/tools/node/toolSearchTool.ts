...
import { ISingularityModelSpecificTool, ToolRegistry } from '../common/toolsRegistry';
...
export class ToolSearchTool implements ISingularityModelSpecificTool<IToolSearchParams> {
	constructor(
