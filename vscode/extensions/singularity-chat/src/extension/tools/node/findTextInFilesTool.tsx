...
export class FindTextInFilesTool implements ISingularityTool<IFindTextInFilesToolParams> {
...
Then if you want to include those files you can call the tool again by setting "includeIgnoredFiles" to true.`;
	...
	async resolveInput(input: IFindTextInFilesToolParams, _promptContext: IBuildPromptContext, mode: SingularityToolMode): Promise<IFindTextInFilesToolParams> {
		...
		return {
			defaultMaxResults: mode === SingularityToolMode.FullContext ? this.getMaxResultsCap() : this.getDefaultMaxResults(),
			...input,
			includePattern,
		};
	}
