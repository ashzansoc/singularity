...
class SkillTool implements ISingularityTool<ISkillParams> {
...
Task: ${query}`;
	...
	async resolveInput(input: ISkillParams, promptContext: IBuildPromptContext, _mode: SingularityToolMode): Promise<ISkillParams> {
