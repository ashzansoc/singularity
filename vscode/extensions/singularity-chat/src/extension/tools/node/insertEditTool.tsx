...
export class EditFileTool implements ISingularityTool<IEditFileParams> {
	...
	async invoke(options: vscode.LanguageModelToolInvocationOptions<IEditFileParams>, token: vscode.CancellationToken) {
		await assertPathNotOwnedByExecutionSubagent(options.input.filePath, this.promptContext);
