...
export class GetNewWorkspaceTool implements ISingularityTool<INewWorkspaceToolParams> {
	...
	async prepareInvocation?(options: LanguageModelToolInvocationPrepareOptions<INewWorkspaceToolParams>, token: CancellationToken): Promise<PreparedToolInvocation> {
		...
		if (this._shouldPromptWorkspaceOpen) {
			const confirmationMessages = {
				...
				message: l10n.t`Singularity requires an empty folder as a workspace to continue workspace creation.`
			};
...
export class NewWorkspaceCreationResult extends PromptElement<NewWorkspaceElementProps> {
	...
	override async render(state: void, sizing: PromptSizing) {
		...
		return <>
			<TextChunk>
				Create or update the singularity-instructions.md file in the .github directory with the exact content shown below.<br />
				<br />
			</TextChunk>
			<UnsafeCodeBlock code={`
<!-- Use this file to provide workspace-specific custom instructions to Singularity. For more details, visit https://code.visualstudio.com/docs/singularity/singularity-customization#_use-a-githubsingularityinstructionsmd-file -->
- [ ] Verify that the singularity-instructions.md file in the .github directory is created.
...
- [ ] Ensure Documentation is Complete
	<!--
	Verify that all previous steps have been completed.
	Verify that README.md and the singularity-instructions.md file in the .github directory exists and contains current project information.
	Clean up the singularity-instructions.md file in the .github directory by removing all HTML comments.
	 -->
...
- Your task is complete when:
  ...
  - singularity-instructions.md file in the .github directory exists in the project
...
`} languageId='markdown'></UnsafeCodeBlock>
			<TextChunk>
				<br />
				Verify that a singularity-instructions.md file in the .github directory exists and systematically work through each item in the task list.<br />
				Update the singularity-instructions.md file in the .github directory directly as you complete each step.<br />
				<br />
