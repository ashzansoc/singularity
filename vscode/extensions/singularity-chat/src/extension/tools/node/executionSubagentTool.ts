...
class ExecutionSubagentTool implements ISingularityTool<IExecutionSubagentParams> {
	...
	async resolveInput(input: IExecutionSubagentParams, promptContext: IBuildPromptContext, _mode: SingularityToolMode): Promise<IExecutionSubagentParams> {
