...
export enum ToolName {
	...
	GetNotebookSummary = 'singularity_getNotebookSummary',
	...
	RunRuntimeEngine = 'run_runtime_engine',
	LlmWiki = 'llm_wiki',
	Skill = 'skill',
...
export enum ContributedToolName {
	ApplyPatch = 'singularity_applyPatch',
	Codebase = 'singularity_searchCodebase',
	SearchWorkspaceSymbols = 'singularity_searchWorkspaceSymbols',
	VSCodeAPI = 'singularity_getVSCodeAPI',
	/** @deprecated moving to core soon */
	RunTests = 'singularity_runTests1',
	FindFiles = 'singularity_findFiles',
	FindTextInFiles = 'singularity_findTextInFiles',
	ReadFile = 'singularity_readFile',
	ViewImage = 'singularity_viewImage',
	ListDirectory = 'singularity_listDirectory',
	GetErrors = 'singularity_getErrors',
	GetScmChanges = 'singularity_getChangedFiles',
	ReadProjectStructure = 'singularity_readProjectStructure',
	CreateNewWorkspace = 'singularity_createNewWorkspace',
	CreateNewJupyterNotebook = 'singularity_createNewJupyterNotebook',
	EditFile = 'singularity_insertEdit',
	CreateFile = 'singularity_createFile',
	ReplaceString = 'singularity_replaceString',
	MultiReplaceString = 'singularity_multiReplaceString',
	EditNotebook = 'singularity_editNotebook',
	RunNotebookCell = 'singularity_runNotebookCell',
	GetNotebookSummary = 'singularity_getNotebookSummary',
	ReadCellOutput = 'singularity_readNotebookCellOutput',
	InstallExtension = 'singularity_installExtension',
	FetchWebPage = 'singularity_fetchWebPage',
	Memory = 'singularity_memory',
	FindTestFiles = 'singularity_findTestFiles',
	GithubSemanticRepoSearch = 'singularity_githubRepo',
	GithubTextSearch = 'singularity_githubTextSearch',
	CreateAndRunTask = 'singularity_createAndRunTask',
	CreateDirectory = 'singularity_createDirectory',
	RunVscodeCmd = 'singularity_runVscodeCommand',
	EditFilesPlaceholder = 'singularity_editFiles',
	SwitchAgent = 'singularity_switchAgent',
	ResolveMemoryFileUri = 'singularity_resolveMemoryFileUri',
	SessionStoreSql = 'singularity_sessionStoreSql',
}
...
export const toolCategories: Record<ToolName, ToolCategory> = {
	...
	[ToolName.RunRuntimeEngine]: ToolCategory.Core,
	[ToolName.LlmWiki]: ToolCategory.Core,
