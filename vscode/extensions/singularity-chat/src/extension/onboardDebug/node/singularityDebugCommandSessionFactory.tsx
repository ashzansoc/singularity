...
import { IStartOptions, StartResult, StartResultKind } from './singularityDebugWorker/shared';
import { IStartDebuggingParsedResponse } from './parseLaunchConfigFromResponse';

const STORAGE_KEY = 'singularity-chat.terminalToDebugging.configs';
const LRU_SIZE = 30;
...
export class SingularityDebugCommandSessionFactory {
	constructor(
	...
	public async start({ args, cwd, forceNew, printOnly, save }: IStartOptions, token: CancellationToken): Promise<StartResult> {
		...
		"onboardDebug.commandExecuted" : {
			"owner": "connor4312",
			"comment": "Reports usages of the singularity-debug command",
		...
		*/
		...
		if (!record || forceNew) {
			...
			"onboardDebug.sessionConfigGenerated" : {
				"owner": "connor4312",
				"comment": "Reports a generated config for the singularity-debug command",
				"binary": { "classification": "SystemMetaData", "purpose": "FeatureInsight", "comment": "Binary executed with the command" },
