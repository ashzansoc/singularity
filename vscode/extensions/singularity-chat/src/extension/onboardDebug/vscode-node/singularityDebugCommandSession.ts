...
export const handleDebugSession = (
	...
	async function followup() {
		switch (once ? 'Q' : await handle.getFollowupKeys(SingularityDebugCommandHandle.SINGULARITY_LABEL.length + 3)) {
			case 'Enter':
