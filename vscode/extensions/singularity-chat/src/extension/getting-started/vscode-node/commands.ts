...
export class WalkthroughCommandContribution extends Disposable {
	constructor() {
		super();
		this._register(vscode.commands.registerCommand('singularity.chat.open.walkthrough', () => {
			vscode.commands.executeCommand('workbench.action.openWalkthrough', { category: 'Singularity.singularity-chat#singularityWelcome' }, /* toSide */ false);
		}));

		this._register(vscode.commands.registerCommand('singularity.chat.mcp.viewContext7', () => {
