...
export class VSCodeContextProviderApiV1 implements Singularity.ContextProviderApiV1 {
	...
	registerContextProvider<T extends Singularity.SupportedContextItem>(provider: Singularity.ContextProvider<T>): Disposable {
