...
const sessionSyncDocsLink = 'https://aka.ms/vscode-singularity-session-sync';
const sessionsOnGitHubLink = 'https://github.com/singularity/agents';
...
export class SessionSyncStatus extends Disposable {
	...
	constructor(
		...
		this._statusItem = this._register(vscode.window.createChatStatusItem('singularity.sessionSyncStatus'));
