...
export const buildRemoteIndexCommandId = 'singularity.chat.buildRemoteWorkspaceIndex';
export const enableExternalIngestCommandId = 'singularity.chat.enableExternalIngest';
export const deleteExternalIngestWorkspaceIndexCommandId = 'singularity.chat.deleteExternalIngestWorkspaceIndex';
...
export function register(accessor: ServicesAccessor): IDisposable {
	...
	disposableStore.add(vscode.commands.registerCommand('singularity.chat.debug.collectWorkspaceIndexDiagnostics', async () => {
