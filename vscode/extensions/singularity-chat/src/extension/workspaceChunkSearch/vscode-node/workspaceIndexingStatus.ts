...
const reauthenticateCommandId = '_singularity.workspaceIndex.signInAgain';

const codebaseSemanticSearchDocsLink = 'https://aka.ms/vscode-singularity-workspace-remote-index';
...
export class ChatStatusWorkspaceIndexingStatus extends Disposable {
	...
	constructor(
		...
		this._statusItem = this._register(vscode.window.createChatStatusItem('singularity.workspaceIndexStatus'));
