...
describe('SettingsSchema', () => {
	...
	test('only deprecates unknown advanced settings', () => {
		const registeredChatSetting = 'singularity.chat.chat.advanced.feature[preview].enabled';
		const registeredSharedSetting = 'singularity.chat.advanced.sharedFeature';
		...
		expect({
			...
			unknownChatSetting: unknownAdvancedSettingRegex.test('singularity.chat.chat.advanced.unknown'),
			unknownSharedSetting: unknownAdvancedSettingRegex.test('singularity.chat.advanced.unknown'),
			emptyRegistryUnknownSetting: new RegExp(emptyRegistryPatternSource).test('singularity.chat.chat.advanced.unknown'),
			emptyAdvancedSuffix: unknownAdvancedSettingRegex.test('singularity.chat.chat.advanced.'),
			unrelatedSetting: unknownAdvancedSettingRegex.test('editor.fontSize'),
			wrongSeparators: unknownAdvancedSettingRegex.test('githubXsingularityXchatXadvancedXunknown'),
