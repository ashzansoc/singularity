...
export class RepoInfoTelemetry {
	...
	constructor(
		...
		@ISingularityTokenStore private readonly _singularityTokenStore: ISingularityTokenStore,
	) { }
	...
	*/
	...
	private async _sendRepoInfoTelemetry(location: 'begin' | 'end'): Promise<Map<string, RepoInfoTelemetryData | undefined>> {
		...
		const isInternal = !!this._singularityTokenStore.singularityToken?.isInternal;
