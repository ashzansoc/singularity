...
suite.skipIf(process.platform === 'win32')('TestFileFinder', function () {
	...
	test('determine java test file with absolute path', async () => {
		await assertTestFileFoundAsync(
			'/Users/singularity/git/commons-io/src/main/java/org/apache/commons/io/EndianUtils.java',
			'/Users/singularity/git/commons-io/src/test/java/org/apache/commons/io/EndianUtilsTest.java',
			'file:///Users/singularity/git/commons-io'
		);
	});

	test('determine rb test file with absolute path', async () => {
		await assertTestFileFoundAsync(
			'/Users/singularity/git/github/foo/util.rb',
			'/Users/singularity/git/github/test/foo/util_test.rb',
			'file:///Users/singularity/git/github'
		);
	});

	test('determine php test file with absolute path', async () => {
		await assertTestFileFoundAsync(
			'/Users/singularity/git/github/foo/util.php',
			'/Users/singularity/git/github/tests/utilTest.php',
			'file:///Users/singularity/git/github'
		);
	});
	...
	test('determine ps1 test file with absolute path', async () => {
		await assertTestFileFoundAsync(
			'/Users/singularity/git/github/foo/util.ps1',
			'/Users/singularity/git/github/Tests/util.Tests.ps1',
			'file:///Users/singularity/git/github'
		);
	});
