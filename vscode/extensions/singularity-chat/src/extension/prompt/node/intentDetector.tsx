...
import { SINGULARIT_IDENTITY_INSTRUCTIONS } from '../../prompts/node/base/singularityIdentity';
	...
	private sendTelemetry(
		...
		/* __GDPR__
			"intentDetection" : {
				...
				"detectedIntent": { "classification": "SystemMetaData", "purpose": "FeatureInsight", "comment": "Intent that was detected by Singularity" },
...
class IntentDetectionPrompt extends PromptElement<IntentDetectionPromptProps> {
	...
	async render() {
		...
		try {
			if (documentContext !== undefined && !(await this._ignoreService.isSingularityIgnored(documentContext.document.uri))) {
