...
import { SingularityDebugCommandContribution } from '../../onboardDebug/vscode-node/singularityDebugCommandContribution';
...
export const vscodeNodeContributions: IExtensionContributionFactory[] = [
	...
	asContributionFactory(SingularityDebugCommandContribution),
	...
	// Explore subagent (+ org agents). User-facing modes ship via package.json chatAgents.
 ...
 * Anything that contributes a singularity chat feature that doesn't need
