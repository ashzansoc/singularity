...
export interface RequestDetails {
	...
	/** Singularity SDK request ID — may not be available until the request completes. */
	 ...
	 */
	toolIdEditMap: { [singularityToolId: string]: string };
...
export interface ChatSessionMetadataFile {
	...
	/**
	 * Whether the session metadata has been written to the Singularity CLI session state directory.
	 */
...
/**
 * One line in `~/.singularity/vscode.session.worktree.jsonl`. Maps a session id
