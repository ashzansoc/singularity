...
export interface IClaudeSlashCommandHandler {
	 ...
	 *
	 * @example "singularity.claude.hooks"
	 */
 ...
 *    - Under `contributes.commands`: Add the VS Code command (e.g., `singularity.claude.mycommand`)
 ...
 *     readonly commandId = 'singularity.claude.mycommand'; // For Command Palette
 *
