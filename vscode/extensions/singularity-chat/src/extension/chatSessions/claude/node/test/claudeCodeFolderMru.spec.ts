...
describe('ClaudeCodeFolderMruService', () => {
	...
	it('skips sessions with .worktrees/singularity- cwd', async () => {
		sessionService.sessions = [
			makeSession({ id: 's1', cwd: '/Users/test/repo/.worktrees/singularity-abc123' }),
		];
	...
	it('filters git repos with .worktrees/singularity- path', async () => {
		gitService.recentRepos = [
			{ rootUri: URI.file('/Users/test/repo/.worktrees/singularity-abc123'), lastAccessTime: 100 },
		];
