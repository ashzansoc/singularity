...
export const ISingularityCLISessionTracker = createDecorator<ISingularityCLISessionTracker>('ISingularityCLISessionTracker');
...
export interface ISingularityCLISessionTracker extends Disposable {
...
export class SingularityCLISessionTracker extends Disposable implements ISingularityCLISessionTracker {
	...
	getSessionDisplayName(sessionId: string): string {
		return this._sessionNames.get(sessionId) || l10n.t('Singularity CLI Session');
	}
