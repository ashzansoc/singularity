...
export const ACCEPT_DIFF_COMMAND = 'singularity.chat.chat.singularityCLI.acceptDiff';
export const REJECT_DIFF_COMMAND = 'singularity.chat.chat.singularityCLI.rejectDiff';
