...
import type { ISingularityCLISessionTracker } from '../singularityCLISessionTracker';
...
export class MockSessionTracker {
	...
	asTracker(): ISingularityCLISessionTracker {
		return this as unknown as ISingularityCLISessionTracker;
	}
}
