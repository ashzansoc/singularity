...
class FakeToolsService implements IToolsService {
	...
	modelSpecificTools: IObservable<{ definition: vscode.LanguageModelToolDefinition; tool: ISingularityTool<unknown> }[]> = constObservable([]);
	...
	getSingularityTool(): ISingularityTool<unknown> | undefined { return undefined; }
