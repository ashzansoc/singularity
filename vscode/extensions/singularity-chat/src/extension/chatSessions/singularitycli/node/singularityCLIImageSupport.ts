...
export interface ISingularityCLIImageSupport {
...
export const ISingularityCLIImageSupport = createServiceIdentifier<ISingularityCLIImageSupport>('ISingularityCLIImageSupport');

export class SingularityCLIImageSupport implements ISingularityCLIImageSupport {
	readonly _serviceBrand: undefined;
	...
	constructor(
		...
		this.storageDir = URI.joinPath(this.context.globalStorageUri, 'singularity-cli-images');
	...
	private async initialize(): Promise<void> {
		try {
			...
			this.logService.error(`[SingularityCLISession] ImageStorage: Failed to initialize`, error);
		}
	}
