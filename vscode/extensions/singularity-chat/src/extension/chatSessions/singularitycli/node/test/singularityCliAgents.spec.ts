...
import { SingularityCLIAgents } from '../singularityCli';
...
describe('SingularityCLIAgents', () => {
	...
	function createAgents(options: { sdkAgentsByCall: ReadonlyArray<ReadonlyArray<SweCustomAgent>>; customAgents?: PromptFileInfo[] }): { agents: SingularityCLIAgents; promptsService: MockPromptsService } {
		...
		const agents = new SingularityCLIAgents(
			promptsService,
