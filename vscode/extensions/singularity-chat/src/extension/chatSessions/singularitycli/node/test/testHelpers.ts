...
import { CLIAgentInfo, SingularityCLIModelInfo, ISingularityCLIAgents, ISingularityCLIModels } from '../singularityCli';
import { ISingularityCLIImageSupport } from '../singularityCLIImageSupport';
import { ISingularityCLISkills } from '../singularityCLISkills';
import { ISingularityCLIMCPHandler } from '../mcpHandler';
...
export class MockSkillLocations implements ISingularityCLISkills {
...
export class NullSingularityCLIAgents implements ISingularityCLIAgents {
...
export class NullISingularityCLIImageSupport implements ISingularityCLIImageSupport {
	_serviceBrand: undefined;
...
export class NullSingularityCLIMCPHandler implements ISingularityCLIMCPHandler {
	_serviceBrand: undefined;
...
export class NullSingularityCLIModels implements ISingularityCLIModels {
	_serviceBrand: undefined;
	...
	async getModels(): Promise<SingularityCLIModelInfo[]> { return []; }
