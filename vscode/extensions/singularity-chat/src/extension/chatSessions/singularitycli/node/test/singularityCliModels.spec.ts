...
import { SingularityCLIModels, type SingularityCLIModelInfo, type ISingularityCLISDK } from '../singularityCli';
...
const FAKE_MODELS: SingularityCLIModelInfo[] = [
...
function buildAutoModel(defaultModel?: SingularityCLIModelInfo): LanguageModelChatInformation {
	return {
		id: 'auto',
		name: 'Auto',
		tooltip: 'Auto routes based on your task and real-time system health and model performance. [Learn More](https://docs.github.com/en/singularity/concepts/models/auto-model-selection)',
...
function createMockSDK(models: SingularityCLIModelInfo[] = FAKE_MODELS): ISingularityCLISDK {
	return {
...
describe('SingularityCLIModels', () => {
	...
	function createModels(options: { hasSession?: boolean; sdk?: ISingularityCLISDK; configService?: MockConfigurationService } = {}): { models: SingularityCLIModels; auth: MockAuthenticationService; configService: MockConfigurationService } {
		...
		const models = new SingularityCLIModels(
			sdk,
			extensionContext,
			logService,
	...
	describe('onDidAuthenticationChange', () => {
		...
		it('returns fresh models after auth change', async () => {
			const updatedModels: SingularityCLIModelInfo[] = [
