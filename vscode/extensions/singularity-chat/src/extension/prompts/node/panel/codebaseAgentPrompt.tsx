	...
	async render(state: void, sizing: PromptSizing) {
		...
		return (
			<>
				...
				<ChatToolCalls priority={899} flexGrow={3} promptContext={this.props.promptContext} toolCallRounds={toolCallRounds} toolCallResults={toolCallResults} toolCallMode={SingularityToolMode.FullContext} />
