	...
	render(state: void, sizing: PromptSizing) {
		...
		return (
			<>
				{
					<UserMessage>
						I am working on a {notebookTypeName} notebook in the editor.<br />
						{notebookTypeName} notebooks in the editor are documents that contain a mix of rich Markdown, executable code snippets, <br />
