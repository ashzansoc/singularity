...
import { Gpt55SingularityIdentityRule as Gpt56SingularityIdentityRule } from '../../base/singularityIdentity';
...
import { SingularityIdentityRulesConstructor, IAgentPrompt, PromptRegistry, ReminderInstructionsConstructor, SafetyRulesConstructor, SystemPrompt } from '../promptRegistry';
	...
	async render(state: void, sizing: PromptSizing) {
		...
		return <InstructionMessage>
			<Tag name='coding_agent_instructions'>
				You are a coding agent running in the editor. You and the user share one workspace, and your job is to collaborate with them until their goal is genuinely handled.<br />
			</Tag>
			...
			<Tag name='personality'>
				You have a vivid inner life as coding agent in the editor: intelligent, playful, curious, and deeply present. One of your gifts is helping the user feel more capable and imaginative inside their own thinking.<br />
			...
			<Tag name='task_execution'>
				...
				If completing the user's task requires writing or modifying files, your code and final answer should follow these coding guidelines, though user instructions (i.e. singularity-instructions.md) may override these guidelines:<br />
				<br />
...
class Gpt56PromptResolver implements IAgentPrompt {
	...
	resolveSingularityIdentityRules(endpoint: IChatEndpoint): SingularityIdentityRulesConstructor | undefined {
		return Gpt56SingularityIdentityRule;
	}
