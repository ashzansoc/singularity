...
import { SingularityIdentityRules } from '../base/singularityIdentity';
...
export type SingularityIdentityRulesConstructor = new (props: BasePromptElementProps, ...args: any[]) => PromptElement<BasePromptElementProps>;
...
export interface AgentPromptCustomizations {
	...
	readonly SingularityIdentityRulesClass: SingularityIdentityRulesConstructor;
...
export const PromptRegistry = new class {
	...
	async resolveAllCustomizations(
		...
		return {
			...
			SingularityIdentityRulesClass: agentPrompt?.resolveSingularityIdentityRules?.(endpoint) ?? SingularityIdentityRules,
