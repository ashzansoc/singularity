...
import { Conversation, ISingularityChatResultIn, normalizeSummariesOnRounds, Turn, TurnStatus } from '../../../../prompt/common/conversation';
...
suite('Agent Summarization', () => {
	...
	async function testSummaryPrevTurnMultiple(promptType: TestPromptType) {
		...
		const previousTurnResult: ISingularityChatResultIn = {
			metadata: {
				summary: {
					text: 'summarized 1!',
		...
		const result: ISingularityChatResultIn = {
			metadata: {
				summary: {
					text: 'summarized 2!',
	...
	async function testSummarizeWithNoRoundsInCurrentTurn(promptType: TestPromptType) {
		...
		const previousTurn2Result: ISingularityChatResultIn = {
			metadata: {
				toolCallRounds: [],
				summary: {
