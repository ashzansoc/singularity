...
import { GPT5SingularityIdentityRule } from '../../base/singularityIdentity';
...
import { SingularityIdentityRulesConstructor, IAgentPrompt, PromptRegistry, ReminderInstructionsConstructor, SafetyRulesConstructor, SystemPrompt, ToolReferencesHintConstructor } from '../promptRegistry';
	...
	async render(state: void, sizing: PromptSizing) {
		...
		return <InstructionMessage>
			<Tag name='coding_agent_instructions'>
				You are a coding agent running in the editor. You are expected to be precise, safe, and helpful.<br />
...
class DefaultGpt5PromptResolver implements IAgentPrompt {
	...
	resolveSingularityIdentityRules(endpoint: IChatEndpoint): SingularityIdentityRulesConstructor | undefined {
		return GPT5SingularityIdentityRule;
	}
