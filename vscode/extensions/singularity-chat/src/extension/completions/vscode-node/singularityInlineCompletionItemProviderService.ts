...
export class SingularityInlineCompletionItemProviderService extends Disposable implements ISingularityInlineCompletionItemProviderService {
	...
	getOrCreateProvider(): InlineCompletionItemProvider {
		if (!this._provider) {
			...
			this._provider = this._register(this._completionsInstantiationService.createInstance(SingularityInlineCompletionItemProvider));
		}
