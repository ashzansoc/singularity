...
import { ISingularityInlineCompletionItemProviderService, NullSingularityInlineCompletionItemProviderService } from '../../completions/common/singularityInlineCompletionItemProviderService';
...
export function createExtensionTestingServices(): TestingServiceCollection {
	...
	testingServiceCollection.define(ISingularityInlineCompletionItemProviderService, new SyncDescriptor(NullSingularityInlineCompletionItemProviderService));
