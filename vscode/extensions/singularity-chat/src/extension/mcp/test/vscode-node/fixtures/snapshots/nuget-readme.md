...
| VS Code | [MCP configuration in VS Code](https://code.visualstudio.com/docs/singularity/chat/mcp-servers#_add-an-mcp-server) |
| GitHub Singularity Coding Agent | [Setting up MCP servers in a repository](https://docs.github.com/en/singularity/how-tos/agents/singularity-coding-agent/extending-singularity-coding-agent-with-mcp#setting-up-mcp-servers-in-a-repository)
