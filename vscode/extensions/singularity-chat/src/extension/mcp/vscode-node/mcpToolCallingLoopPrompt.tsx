	...
	async render() {
		...
		return (
			<>
				...
				<ChatToolCalls priority={899} flexGrow={2} promptContext={this.props.promptContext} toolCallRounds={toolCallRounds} toolCallResults={toolCallResults} toolCallMode={SingularityToolMode.FullContext} />
			</>
		);
	}
}
