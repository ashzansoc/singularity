...
interface SingularityContentExclusion {
	type: 'singularityContentExclusion';
}
...
export const _singularityContentExclusion: SingularityContentExclusion = { type: 'singularityContentExclusion' };
