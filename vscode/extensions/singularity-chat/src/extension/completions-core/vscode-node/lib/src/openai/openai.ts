...
export interface APIChoice {
	...
	singularityAnnotations?: SingularityNamedAnnotationList; // optional annotations from the proxy
...
export interface APIJsonData {
	...
	/* Singularity-specific annotations returned by the proxy. */
	singularity_annotations?: SingularityNamedAnnotationList;
...
export function convertToAPIChoice(
	...
	return {
		...
		singularityAnnotations: jsonData.singularity_annotations,
