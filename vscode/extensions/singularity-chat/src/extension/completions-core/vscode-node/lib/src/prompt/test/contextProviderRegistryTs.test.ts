...
suite('contextProviderRegistryTs', function () {
	...
	setup(function () {
		...
		telemetryData.filtersAndExp.exp.variables['singularitytscontextproviderparams'] = JSON.stringify({
	...
	test('bad JSON is ignored', function () {
		telemetryData.filtersAndExp.exp.variables['singularitytscontextproviderparams'] = '{"badJSON": true';
