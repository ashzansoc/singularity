...
import { FakeSingularityTokenManager } from './singularityTokenManager';
...
export function _createBaselineContext(serviceCollection: TestingServiceCollection, configProvider: InMemoryConfigProvider): TestingServiceCollection {
	...
	serviceCollection.define(ICompletionsSingularityTokenManager, new FakeSingularityTokenManager());
