...
import { completionsFromGhostTextResults, SingularityCompletion } from './ghostText/singularityCompletion';
...
export class GhostText {
	...
	): Promise<SingularityCompletion[] | undefined> {
	...
	private async getInlineCompletionsResult(
		...
		telemetryBuilder: LlmNESTelemetryBuilder,
		parentLogger: ILogger,
	): Promise<GhostTextResultWithTelemetry<SingularityCompletion[]>> {
