...
import { SingularityExtensionStatus, ICompletionsExtensionStatus } from '../extensionStatus';
...
export function createExtensionTestingContext() {
	...
	serviceCollection.define(ICompletionsExtensionStatus, new SingularityExtensionStatus());
