...
import { runSolutions } from '../lib/singularityPanel/panel';
...
/**
 * Class representing a Open Singularity list using a ITextDocument as a way of displaying results.
 * Currently only used in the VSCode extension.
 */
export class SingularityListDocument extends BaseListDocument<PanelCompletion> {
	constructor(
	...
	protected createPanelCompletion(
		...
		return {
			...
			singularityAnnotations: baseCompletion.singularityAnnotations,
