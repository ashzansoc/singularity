...
export class ModelPickerManager {
	// URL for information about Singularity models
	private readonly MODELS_INFO_URL = 'https://aka.ms/SingularityCompletionsModelPickerLearnMore';
	...
	async setUserSelectedCompletionModel(modelId: string | null) {
		return workspace
			.getConfiguration(SingularityConfigPrefix)
