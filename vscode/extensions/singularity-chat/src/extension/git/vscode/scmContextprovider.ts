...
class ScmContextResolver implements Singularity.ContextResolver<Singularity.SupportedContextItem> {
	...
	async *resolve(request: Singularity.ResolveRequest, token: CancellationToken): AsyncIterable<Singularity.SupportedContextItem> {
