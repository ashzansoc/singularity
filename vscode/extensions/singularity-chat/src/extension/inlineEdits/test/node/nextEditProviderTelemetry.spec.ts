...
describe('TelemetrySender', () => {
	...
	describe('scheduleSendingEnhancedTelemetry', () => {
		...
		test('sends after initial timeout when no workspace', async () => {
			...
			expect(telemetryService.enhancedEvents[0].eventName).toBe('singularity-nes/provideInlineEdit');
	...
	describe('fetchResult disambiguation', () => {
		...
		// `singularity_v0_next_edit_suggestion_restricted_code_snippet` table.
