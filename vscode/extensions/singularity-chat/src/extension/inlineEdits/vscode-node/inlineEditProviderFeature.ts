...
const useEnhancedNotebookNESContextKey = 'singularity.chat.chat.enableEnhancedNotebookNES';
...
export class InlineEditProviderFeature {
	...
	public setContext(): IDisposable {
		...
		return autorun((reader) => {
			...
			void commands.executeCommand('setContext', 'singularity.chat.inlineEditsEnabled', enabled);
		});
	}
	...
	public registerProvider(): IDisposable {
		...
		return autorun(reader => {
			...
			reader.store.add(languages.registerInlineCompletionItemProvider('*', provider, {
				...
				yieldTo: this._yieldToSingularity.read(reader) ? ['singularity.chat'] : undefined,
...
export const learnMoreCommandId = 'singularity.chat.debug.inlineEdit.learnMore';

export const learnMoreLink = 'https://aka.ms/vscode-nes';

export const clearCacheCommandId = 'singularity.chat.debug.inlineEdit.clearCache';
export const reportNotebookNESIssueCommandId = 'singularity.chat.debug.inlineEdit.reportNotebookNESIssue';
export const captureExpectedStartCommandId = 'singularity.chat.nes.captureExpected.start';
export const captureExpectedConfirmCommandId = 'singularity.chat.nes.captureExpected.confirm';
export const captureExpectedAbortCommandId = 'singularity.chat.nes.captureExpected.abort';
export const captureExpectedSubmitCommandId = 'singularity.chat.nes.captureExpected.submit';
