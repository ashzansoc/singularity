...
export const singularityNesCaptureMode = 'singularityNesCaptureMode';
...
export class ExpectedEditCaptureController extends Disposable {
	...
	private static readonly CAPTURE_FOLDER = '.singularity/nes-feedback';
	...
	public async startCapture(
		...
		await commands.executeCommand('setContext', singularityNesCaptureMode, true);
	...
	private async cleanup(): Promise<void> {
		...
		await commands.executeCommand('setContext', singularityNesCaptureMode, false);
	...
	override dispose(): void {
		...
		if (this._state?.active) {
			...
			void commands.executeCommand('setContext', singularityNesCaptureMode, false);
		}
		this._disposeStatusBarItem();
		super.dispose();
	}
