...
export class DocumentFilter {
	...
	/**
	 * Whether Singularity inline suggestions (inline completions and next edit suggestions) are
	 * enabled for the given language according to the per-language `singularity.chat.enable` setting.
	 */
