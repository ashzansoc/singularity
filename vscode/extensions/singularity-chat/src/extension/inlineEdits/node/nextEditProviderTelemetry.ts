 ...
 */
export const NES_GH_TELEMETRY_EVENT_NAME = 'singularity-nes/provideInlineEdit';
 ...
 * Singularity completions are disabled (e.g. markdown, plaintext), non-file URI schemes,
 * and singularity-ignored files are excluded. This matches the scope of {@link DebugRecorder}.
 *
...
export class TelemetrySender implements IDisposable {
	 ...
	 * languages where Singularity completions are disabled (e.g. markdown) and singularity-ignored files are excluded,
