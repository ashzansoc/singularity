			...
			queries: [
				{
					...
					validate: async (outcome, workspace, accessor) => {
						...
						assert.ok(outcome.fileContents.includes('Generated by Singularity'));
					}
				}
			]
		});
	...
	configurations = [
		{
			...
			value: [
				...
				{ 'text': `Add a comment: 'Generated by Singularity'`, 'language': 'java' },
			]
		}
	];
	...
	const configurations3 = [
		{
			...
			value: [
				...
				{ 'text': `Add a comment: 'Generated by Singularity'`, 'language': 'typescript' },
			]
		}
	];
