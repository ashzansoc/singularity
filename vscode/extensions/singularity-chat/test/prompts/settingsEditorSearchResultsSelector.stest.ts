...
ssuite({ title: 'settingsEditorSearchResultsSelector', location: 'external' }, () => {
	...
	stest({ description: 'Selects expected agent mode setting' }, async (testingServiceCollection) => {
		...
		const settingsList: SettingListItem[] = [
			{
				'key': 'singularity.chat.chat.codesearch.enabled',
				'type': 'boolean',
			...
			},
			{
				...
				'type': 'boolean',
				'description': 'Enable agent mode for Singularity Chat. When this is enabled, a dropdown appears in the view to toggle agent mode.'
			},
			{
				'key': 'singularity.chat.chat.agent.runTasks',
				'type': 'boolean',
				'description': 'Configures whether Singularity Edits can run workspace tasks in agent mode.'
			},
			{
			...
			{
				'key': 'singularity.chat.advanced',
				'type': 'object'
			},
			{
				'key': 'singularity.chat.chat.newWorkspaceCreation.enabled',
				'type': 'boolean',
			...
			{
				'key': 'singularity.chat.chat.completionContext.typescript.mode',
				'type': 'string',
				'markdownDescription': 'The execution mode of the TypeScript Singularity context provider.',
				'enum': [
					'off',
					'sidecar',
					'on'
			...
			{
				'key': 'singularity.chat.chat.agent.thinkingTool',
				'type': 'boolean',
				'markdownDescription': 'Enables the thinking tool that allows Singularity to think deeply about your request before generating a response in agent mode.'
			},
			{
