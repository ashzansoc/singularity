...
import { SingularityInteractiveEditorSession, SingularityInteractiveEditorSessionProvider, InteractiveEditorRequest } from '../../src/extension/inlineChat/node/inlineChat';
...
export async function simulateInlineChat(
	...
	const provider = instaService.createInstance(SingularityInteractiveEditorSessionProvider, editorAgentName, options.rejectionMessage);
	let session: SingularityInteractiveEditorSession | undefined;
