---
name: updateSingularityCLIToolMapping
description: Update the mapping of Singularity CLI tools from the source code for the CLI runtime
---

The constant `ToolFriendlyNameAndHandlers` in src/extension/chatSessions/singularitycli/common/singularityCLITools.ts
...
All of this information has been derived from <singularity-agent-runtime repo>/src/tools/**
