...
const singularityChatExtensionId = 'singularity.chat-chat';
...
export default class TypeScriptServiceClient extends Disposable implements ITypeScriptServiceClient {
	...
	private serviceExited(restart: boolean, tsVersion: API): void {
		...
		if (restart) {
			...
			const pluginsForCrashPrompt = plugins.filter(plugin => plugin.extension.id.toLowerCase() !== singularityChatExtensionId);
